...
if (!class_exists('wams\core\Mail')) {
	...
	class Mail
	{
		...
		{
			// text emails
			if (!WAMS()->options()->get('email_html')) {
				$nl2br = true;
			}
		...
		public function init_paths()
		{
			 ...
			 *
			 * @since 2.0
			 * @hook wams_email_templates_path_by_slug
			 *
			 ...
			 *     return $paths;
			 * }
			 * add_filter( 'wams_email_templates_path_by_slug', 'my_email_templates_path_by_slug' );
			 */
			$this->path_by_slug = apply_filters('wams_email_templates_path_by_slug', $this->path_by_slug);
		}
		...
		public function locate_template($template_name)
		{
			...
			$template = locate_template(
				array(
					trailingslashit('wams/email' . $blog_id) . $template_name . '.php',
				)
			);
			...
			if (is_multisite() && !$template) {
				$template = locate_template(
					array(
						trailingslashit('wams/email') . $template_name . '.php',
					)
				);
			}
			...
			if (!$template) {
				$path     = !empty($this->path_by_slug[$template_name]) ? $this->path_by_slug[$template_name] : WAMS_PATH . 'templates/email';
			 ...
			 *
			 * @since 2.0
			 * @hook wams_locate_email_template
			 *
			 ...
			 *     return $template;
			 * }
			 * add_filter( 'wams_locate_email_template', 'my_locate_email_template', 10, 2 );
			 */
			return apply_filters('wams_locate_email_template', $template, $template_name);
		}
		...
		public function get_email_template($slug, $args = array())
		{
			 ...
			 *     return $located;
			 * }
			 * add_filter( 'wams_email_template_path', 'my_email_template_path', 10, 3 );
			 */
			$located = apply_filters('wams_email_template_path', $located, $slug, $args);
			 ...
			 *
			 * @since 2.0
			 * @hook wams_before_email_template_part
			 *
			 * @example <caption>Action before email template loading.</caption>
			 * function my_before_email_template_part( $slug, $located, $args ) {
			 *     // your code here
			 * }
			 * add_action( 'wams_before_email_template_part', 'my_before_email_template_part', 10, 3 );
			 */
			do_action('wams_before_email_template_part', $slug, $located, $args);
			 ...
			 *
			 * @since 2.0
			 * @hook wams_after_email_template_part
			 *
			 * @example <caption>Action after email template loading.</caption>
			 * function my_after_email_template_part( $slug, $located, $args ) {
			 *     // your code here
			 * }
			 * add_action( 'wams_after_email_template_part', 'my_after_email_template_part', 10, 3 );
			 */
			do_action('wams_after_email_template_part', $slug, $located, $args);
		...
		public function prepare_template($slug, $args = array())
		{
			...
			if (WAMS()->options()->get('email_html')) {
				 ...
				 *
				 * @since 2.0
				 * @hook wams_email_template_html_formatting
				 *
				 ...
				 *     return $header;
				 * }
				 * add_filter( 'wams_email_template_html_formatting', 'my_email_template_html_formatting', 10, 3 );
				 */
				echo apply_filters('wams_email_template_html_formatting', '<html>', $slug, $args);
				 ...
				 *
				 * @since 2.0
				 * @hook wams_before_email_template_body
				 *
				 * @example <caption>Action before email template body display.</caption>
				 * function my_before_email_template_body( $slug, $args ) {
				 *     // your code here
				 * }
				 * add_action( 'wams_before_email_template_body', 'my_before_email_template_body', 10, 2 );
				 */
				do_action('wams_before_email_template_body', $slug, $args);
				 ...
				 *
				 * @since 2.0
				 * @hook wams_email_template_body_attrs
				 *
				 ...
				 *     return $body_attrs;
				 * }
				 * add_filter( 'wams_email_template_body_attrs', 'my_email_template_body_attrs', 10, 3 );
				 */
				$body_attrs = apply_filters('wams_email_template_body_attrs', 'style="background: #f2f2f2;-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;"', $slug, $args);
?>
...
<?php
			 ...
			 *
			 * @since 2.0
			 * @hook wams_email_send_message_content
			 *
			 ...
			 *     return $message;
			 * }
			 * add_filter( 'wams_email_send_message_content', 'my_email_send_message_content', 10, 3 );
			 */
			$message = apply_filters('wams_email_send_message_content', $message, $slug, $args);

			add_filter('wams_template_tags_patterns_hook', array(&$this, 'add_placeholder'));
			add_filter('wams_template_tags_replaces_hook', array(&$this, 'add_replace_placeholder'));

			// Convert tags in email template.
			return wams_convert_tags($message, $args);
		}
		...
		public function send($email, $template, $args = array())
		{
			...
			if (empty(WAMS()->options()->get($template . '_on'))) {
				return;
			}
			/**
			 ...
			 *
			 * @since 2.6.1
			 * @hook wams_disable_email_notification_sending
			 *
			 ...
			 *     return $disabled;
			 * }
			 * add_filter( 'wams_disable_email_notification_sending', 'my_disable_email_notification_sending', 10, 4 );
			 */
			$hook_disabled = apply_filters('wams_disable_email_notification_sending', false, $email, $template, $args);
			 ...
			 *
			 * @since 2.0
			 * @hook wams_before_email_notification_sending
			 *
			 ...
			 *     // your code here
			 * }
			 * add_action( 'wams_before_email_notification_sending', 'my_before_email_notification_sending', 10, 3 );
			 */
			do_action('wams_before_email_notification_sending', $email, $template, $args);

			$this->attachments = array();
			$mail_from         = WAMS()->options()->get('mail_from') ? WAMS()->options()->get('mail_from') : get_bloginfo('name');
			$mail_from_addr    = WAMS()->options()->get('mail_from_addr') ? WAMS()->options()->get('mail_from_addr') : get_bloginfo('admin_email');
			$this->headers     = 'From: ' . stripslashes($mail_from) . ' <' . $mail_from_addr . '>' . "\r\n";

			add_filter('wams_template_tags_patterns_hook', array(WAMS()->mail(), 'add_placeholder'));
			add_filter('wams_template_tags_replaces_hook', array(WAMS()->mail(), 'add_replace_placeholder'));
			 ...
			 *     return $subject;
			 * }
			 * add_filter( 'wams_email_send_subject', 'my_email_send_subject', 10, 2 );
			 */
			$subject = apply_filters('wams_email_send_subject', WAMS()->options()->get($template . '_sub'), $template);
			$subject = wp_unslash(wams_convert_tags($subject, $args));
			 ...
			 *
			 * @since 2.0
			 * @hook wams_after_email_notification_sending
			 *
			 ...
			 *     // your code here
			 * }
			 * add_action( 'wams_after_email_notification_sending', 'my_after_email_notification_sending', 10, 3 );
			 */
			do_action('wams_after_email_notification_sending', $email, $template, $args);
		}
		...
		public function get_template_filename($template_name)
		{
			 ...
			 *
			 * @since 2.0
			 * @hook wams_change_email_template_file
			 *
			 * @example <caption>Change email notification template path.</caption>
			 ...
			 * }
			 * add_filter( 'wams_change_email_template_file', 'my_change_email_template_file' );
			 */
			return apply_filters('wams_change_email_template_file', $template_name);
		}
		...
		public function template_in_theme($template_name)
		{
			...
			$template = locate_template(
				array(
					trailingslashit('wams/email' . $blog_id) . $template_name_file . '.php',
				)
			);
		...
		public function get_template_file($location, $template_name)
		{
			...
			switch ($location) {
				case 'theme':
					...
					$template_path = trailingslashit(get_stylesheet_directory() . '/wams/email' . $blog_id) . $template_name_file . '.php';
					break;
				case 'plugin':
					$path          = !empty($this->path_by_slug[$template_name]) ? $this->path_by_slug[$template_name] : WAMS_PATH . 'templates/email';
			 ...
			 *
			 * @since 2.6.1
			 * @hook wams_email_get_template_file_path
			 *
			 ...
			 * }
			 * add_filter( 'wams_email_get_template_file_path', 'my_email_get_template_file_path' );
			 */
			return apply_filters('wams_email_get_template_file_path', $template_path, $location, $template_name_file);
		}
		...
		/**
		 * WAMS Placeholders for site url, admin email, submit registration.
		 *
		...
		/**
		 * WAMS Replace Placeholders for site url, admin email, submit registration.
		 *
		...
		public function add_replace_placeholder($replace_placeholders)
		{
			...
			$replace_placeholders[] = wams_admin_email();
			$replace_placeholders[] = wams_user_submitted_registration_formatted();
			$replace_placeholders[] = wams_get_core_page('login');
