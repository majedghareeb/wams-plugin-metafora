...
foreach ($menus as $menu) {
	$menu_roles = get_post_meta($menu->ID, 'menu-item-wams_nav_roles', true);
	...
	update_post_meta($menu->ID, 'menu-item-wams_nav_roles', $menu_roles);
}
