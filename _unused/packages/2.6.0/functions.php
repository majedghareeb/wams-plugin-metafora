...
function wams_upgrade_social_fields260()
{
	...
	update_option('wams_last_version_upgrade', '2.6.0');

	if (!empty($fields_for_upgrade)) {
		wp_send_json_success(array('message' => __('Social URLs fields have been successfully updated.', 'wams')));
	} else {
