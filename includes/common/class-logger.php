...
class Logger
{
     ...
     */
    public static $log_dir = WAMS_PATH . 'logs';
    ...
    public static function readLogs()
    {
        ...
        if (file_exists(self::$log_dir)) {
            $logs =  nl2br(file_get_contents(self::$log_file_path));
        }
        return $logs;
    }
    ...
    public static function init()
    {
        ...
        if (!self::$logger_ready) {
            ...
            /** disbale */
            if (isset(get_option('wams_update_settings')['enable_logs']) && get_option('wams_update_settings')['enable_logs'] == 'off') {
                return;
            }
        }
     ...
     * Set log_file_path
     */
    public static function set_log_file_path($log_file_name)
    {
