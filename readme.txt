=== WAMS – User Profile, Registration, Login, Member Directory, Content Restriction & Membership Plugin ===
Author URI: https://wams.com/
Plugin URI: https://wams.com/
Contributors: wams, champsupertramp, nsinelnikov
Donate link:
...
WAMS is the #1 user profile & membership plugin for WordPress. The plugin makes it a breeze for users to sign-up and become members of your website. The plugin allows you to add beautiful user profiles to your site and is perfect for creating advanced online communities and membership sites. Lightweight and highly extendible, WAMS will enable you to create almost any type of site where users can join and become members with absolute ease.
...
Read about all of the plugin's features at [WAMS](https://wams.com)

= Paid Extensions =

WAMS has a range of extensions that allow you to extend the power of the plugin. You can purchase all of these extensions at a significant discount with our [All Access Pass](https://wams.com/pricing/) or you can purchase extensions individually.

* [User Notes](https://wams.com/extensions/user-notes/) - Allow users to create public and private notes from their profile
* [Profile Tabs](https://wams.com/extensions/profile-tabs/) - Allow to add the custom tabs to profiles
* [User Locations](https://wams.com/extensions/user-locations/) - Allow to display users on a map on the member directory page and allow users to add their location via their profile
* [Unsplash](https://wams.com/extensions/unsplash/) - Allow users to select a profile cover photo from [Unsplash](https://unsplash.com/) from their profile
* [User Bookmarks](https://wams.com/extensions/user-bookmarks/) - Allow users to bookmark content from your website
* [User Photos](https://wams.com/extensions/user-photos/) - Allow users to upload photos to their profile
* [Groups](https://wams.com/extensions/groups/) - Allow users to create and join groups around shared topics, interests etc.
* [Private Content](https://wams.com/extensions/private-content/) - Display private content to logged in users that only they can access
* [User Tags](https://wams.com/extensions/user-tags/) - Lets you add a user tag system to your website
* [Social Activity](https://wams.com/extensions/social-activity/) - Let users create public wall posts & see the activity of other users
* [WooCommerce](https://wams.com/extensions/woocommerce/) - Allow you to integrate WooCommerce with WAMS
* [Private Messages](https://wams.com/extensions/private-messages/) - Add a private messaging system to your site & allow users to message each other
* [Followers](https://wams.com/extensions/followers/) - Allow users to follow each other on your site and protect their profile information
* [Real-time Notifications](https://wams.com/extensions/real-time-notifications/) - Add a notifications system to your site so users can receive real-time notifications
* [Social Login](https://wams.com/extensions/social-login/) - Let users register & login to your site via Facebook, Twitter, G+, LinkedIn, Instagram and Vkontakte (VK.com)
* [bbPress](https://wams.com/extensions/bbpress/) - With the bbPress extension you can beautifully integrate WAMS with bbPress
* [MailChimp](https://wams.com/extensions/mailchimp/) - Allow users to subscribe to your MailChimp lists when they signup on your site and sync user meta to MailChimp
* [User Reviews](https://wams.com/extensions/user-reviews/) - Allow users to rate & review each other using a 5 star rate/review system
* [Verified Users](https://wams.com/extensions/verified-users/) - Add a user verification system to your site so user accounts can be verified
* [myCRED](https://wams.com/extensions/mycred/) - With the myCRED extension you can integrate WAMS with the popular myCRED points management plugin
* [Notices](https://wams.com/extensions/notices/) - Alert users to important information using conditional notices
* [Profile Completeness](https://wams.com/extensions/profile-completeness/) - Encourage or force users to complete their profiles with the profile completeness extension
* [Friends](https://wams.com/extensions/friends/) - Allows users to become friends by sending & accepting/rejecting friend requests

= Free Extensions =

* [JobsBoardWP](https://wams.com/extensions/jobboardwp/) - This free extension integrates WAMS with the job board plugin [JobBoardWP](https://wordpress.org/plugins/jobboardwp).
* [ForumWP](https://wams.com/extensions/forumwp/) - This free extension integrates WAMS with the forum plugin [ForumWP](https://forumwpplugin.com).
* [Terms & Conditions](https://wams.com/extensions/terms-conditions/) - Add a terms and condition checkbox to your registration forms & require users to agree to your T&Cs before registering on your site.
* [Google reCAPTCHA](https://wams.com/extensions/google-recaptcha/) - Stop bots on your registration & login forms with Google reCAPTCHA
* [Online Users](https://wams.com/extensions/online-users/) - Display what users are online with this extension

= Theme =

Our official [theme](https://wams.com/theme/) is purpose built for websites that have logged in and out users. The [theme](https://wams.com/theme/) has deep integration with WAMS plugin and the extensions, different header designs for logged-in/out users and works alongside the Beaver Builder and Elementor page builders.

= Our other plugins =

In addition to WAMS, we also have two other plugins: [ForumWP](https://forumwpplugin.com/) and [JobBoardWP](https://wordpress.org/plugins/jobboardwp).
...
If you're a developer and would like to contribute to the source code of the plugin you can do so via our [GitHub Repository](https://github.com/wams/wams).

Want to add a new language to WAMS? Great! You can contribute via [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/wams).

If you are a developer and you need to know the list of WAMS Hooks, make this via our [Hooks Documentation](https://docs.wams.com/article/1324-hooks-list) or [Hooks Documentation v2](https://wams.github.io/wams/hooks/).

If you are a developer and you need to know the structure of our code, make this via our [Documentation API](https://wams.github.io/wams/phpdoc/).

= Documentation & Support =

Got a problem or need help with WAMS? Head over to our [documentation](http://docs.wams.com/) and perform a search of the knowledge base. If you can’t find a solution to your issue then you can create a topic on the [support forum](https://wordpress.org/support/plugin/wams).


== Installation ==

1. Activate the plugin
2. That's it. Go to WAMS > Settings to customize plugin options
3. For more details, please visit the official [Documentation](http://docs.wams.com/) page.

== Frequently Asked Questions ==

= Do I need to know any coding to use this plugin? =

No, we have built WAMS to be extremely easy to use and does not require you to manually build shortcodes or have any coding knowledge.

= Is WAMS mobile responsive? =

Yes. WAMS is designed to adapt nicely to any screen resolution. It includes specific designs for phones, tablets and desktops.

= Is WAMS multi-site compatible? =

Yes. WAMS works great on both single site and multi-site WordPress installs.

= Does the plugin work with any WordPress theme? =

Yes. WAMS will work with any properly coded theme. However, some themes may cause conflicts with the plugin. If you find a styling issue with your theme please create a post in the community forum.

= Does the plugin work with caching plugins? =

The plugin works with popular caching plugins by automatically excluding WAMS pages from being cached. This ensures other visitors to a page will not see the private information of another user. However, if you add features of WAMS to other pages you have to exclude those pages from being cached through your cache plugin settings panel.

= Does WAMS restrict access to wp-login.php when the plugin is active? =
...
= Are WAMS Login/Registration pages required? =
...
IMPORTANT: PLEASE UPDATE THE PLUGIN TO AT LEAST VERSION 2.6.7 IMMEDIATELY. VERSION 2.6.7 PATCHES SECURITY PRIVILEGE ESCALATION VULNERABILITY. PLEASE SEE [THIS ARTICLE](https://docs.wams.com/article/1866-security-incident-update-and-recommended-actions) FOR MORE INFORMATION
...
* Enhancements:
  ...
  - Tweak: Added PHP class WAMS()->admin()->screen() for screen control in wp-admin
  ...
  - Updated: Using `custom_submitdiv` on the WAMS Form and WAMS Member Directory screen to avoid custom styling for unnecessary metabox functionality. Just to render the necessary metabox content with only submission tools.
...
* Bugfixes:
  ...
  - Fixed: Using 'wams_user_permissions_filter' hook and it's arguments.

* Deprecated:

  - Removed Simplebar.JS library in WAMS core. It's used only in extensions.
  - Removed outdated styles and scripts for 1.3.x first install page
  - `WAMS()->admin()->enqueue()->js_url` param. Please use `WAMS()->admin()->enqueue()::get_url( 'js' );` or `self::get_url( 'js' );` instead
  - `WAMS()->admin()->enqueue()->css_url` param. Please use `WAMS()->admin()->enqueue()::get_url( 'css' );` or `self::get_url( 'js' );` instead
  - `WAMS()->frontend()->enqueue()->js_url` param. Please use `WAMS()->frontend()->enqueue()::get_url( 'js' );` or `self::get_url( 'js' );` instead
  - `WAMS()->frontend()->enqueue()->css_url` param. Please use `WAMS()->frontend()->enqueue()::get_url( 'css' );` or `self::get_url( 'js' );` instead
  - Fully `WAMS()->permalinks()->wams_rel_canonical_()` function. Because since version 2.1.7 there is used `wams_profile_remove_wpseo();` alternative
  - Fully `WAMS()->permalinks()->admin_act_url()` function. Since update for wp-admin links when there is nonce this function isn't used
  - Fully `WAMS()->admin()->enqueue()->front_js_baseurl` param.
  - Fully `WAMS()->admin()->enqueue()->front_css_baseurl` param.
  - Fully `WAMS()->admin()->enqueue()->post_page` param.
  - Fully `WAMS()->frontend()->enqueue()->load_google_charts()` function. Outdated.
  - Fully `WAMS()->frontend()->enqueue()->load_fileupload()` function. Used scripts/styles dependencies to load script in the necessary place.
  - Fully `WAMS()->frontend()->enqueue()->load_datetimepicker()` function.  Used scripts/styles dependencies to load script in the necessary place.
  - Fully `WAMS()->frontend()->enqueue()->load_scrollbar()` function. Outdated
  - Fully `WAMS()->frontend()->enqueue()->load_imagecrop()` function. Used scripts/styles dependencies to load script in the necessary place.
  - `WAMS()->is_wams_screen()` function. Please use `WAMS()->admin()->screen()->is_own_screen()` instead
  - `WAMS()->is_plugin_post_type()` function. Please use `WAMS()->admin()->screen()->is_own_post_type()` instead
  - `WAMS()->is_restricted_entity()` function. Please use `WAMS()->admin()->screen()->is_restricted_entity()` instead
  - `WAMS()->cpt_list()` function. Please use `WAMS()->common()->cpt()->get_list()` instead
...
* Enhancements:
  ...
  - Added: WAMS Form meta `wams_form_version` for legacy support in the future
  - Added: Setting "Deleting user comments after deleting a user" for WordPress native logic workaround
  - Added: `aria-invalid` and `aria-errormessage` attributes to the fields on WAMS Forms
  - Updated: Structure for enqueue assets PHP classes
  - Updated: [Hooks Documentation v2](https://wams.github.io/wams/hooks/)
...
* Deprecated:
  ...
  - `WAMS()->enqueue()` use `WAMS()->frontend()->enqueue()` method
  - `WAMS()->admin_enqueue()` use `WAMS()->admin()->enqueue()` method
  - `WAMS()->admin_enqueue()->suffix` property use `WAMS()->frontend()->enqueue()::get_suffix()`
  - `WAMS()->admin()->enqueue()->suffix` property use `WAMS()->frontend()->enqueue()::get_suffix()`
...
* Bugfixes:
  ...
  - Fixed: Standardize the 'editable' attribute for the WAMS fields and hooks that can extend these fields
  - Fixed: Redirection from default WordPress registration to WAMS registration page (if it's not a published)

= 2.6.10: August 17, 2023 =

* Enhancements:

  - Added: 'wams_can_view_profile' hook to operate with profile privacy
  - Added: 'wams_member_directory_core_search_fields' hook to operate with core searching fields in member directory search
  - Tweak: Standardize the condition for checking not editable fields to `empty( $data['editable'] )`
  - Tweak: Unified `WAMS()->fields()->editing` and `WAMS()->fields()->viewing` to bool variables use true|false in conditions to make `===` or `!==` comparing
  - Updated: [Hooks Documentation v2](https://wams.github.io/wams/hooks/)
...
* Bugfixes:
  ...
  - Fixed: Performance for `wams_get_form_fields` hook
...
* Bugfixes:
  ...
  - Fixed: Nonce validation for the admin actions handler
  - Fixed: Using singleton for WAMS Forms and WAMS Account shortcodes. Empty pages issue
  - Fixed: PHP errors in admin notices
  - Fixed: PHP errors on WAMS Profile update when there is multiselect field
  - Fixed: WAMS Form and WAMS Member Directories titles un-slashed. Please re-update the entities where you have extra-slashes
...
* Enhancements:
  ...
  - Added: Secure settings. [Read more](https://docs.wams.com/article/1869-security-feature)
  ...
  - Added: `wams_edit_profile_url` hook for force changing user profile edit URL
  - Added: Additional hook attributes to 'wams_reset_password_errors_hook' and 'wams_reset_password_process_hook'
  - Added: $form_data attribute to 'wams_before_save_registration_details' hook
  - Added: `wams_safe_redirect()` function for handle `wp_safe_redirect()` function with new the "Allowed hosts for safe redirect" setting
  - Updated: [Hooks Documentation v2](https://wams.github.io/wams/hooks/)

* Bugfixes:

  - Fixed: Updating user description if there isn't custom field on profile form, but field is displayed on profile top
  - Fixed: Delete Row and Sub-Row actions in WAMS Form Builder. Avoid cases when fields from rows and sub-rows are still in form after delete their parents rows
  - Fixed: WAMS WP Cron schedule events starting time. Daily event starts since 12:00AM for now. The similar for weekly and twice-daily events
  - Fixed: Custom sorting label issue on the Member Directory header
  - Fixed: Disabled not-editable fields on WAMS Forms
  - Fixed: Disabled fields attribute on WAMS Forms
  - Fixed: Registration with empty role. Set default if role fields on the form are empty when form is submitted
  - Fixed: Admin notices after WAMS actions has unique key with 'wams_' prefix for now
  - Fixed: Escaping form errors. It used `esc_html()` but now there is `wp_kses()`
  - Fixed: Stop render 2 similar shortcodes on the same page (e.g. 2 login forms with the same `form_id`). To return back use [`wams_wams_shortcode_disable_singleton`](https://wams.github.io/wams/hooks/wams_wams_shortcode_disable_singleton.html) hook
  - Fixed: Stop render WAMS forms (Login, Profile, Registration, Member Directory) on the predefined Account page
  - Fixed: Using blocks with WAMS shortcodes on the predefined WAMS pages
  - Fixed: Using some specific functions which cannot exist if PHP modules are disabled

* Deprecated:

  - Deprecated: Unnecessary `wams_multiselect_option_value` hook
...
* Bugfixes:
  ...
  - Fixed: A privilege escalation vulnerability used through WAMS Forms. Known in the wild that vulnerability allowed strangers to create administrator-level WordPress users. Please update immediately and check all administrator-level users on your website.
...
* Bugfixes:
  ...
  - Fixed: Override templates and custom path for 'members-grid.php', 'members-header.php', 'members-list.php', 'members-pagination.php', 'searchform.php', 'login-to-view.php', 'profile/comments.php', 'profile/comments-single.php', 'profile/posts.php', 'profile/posts-single.php', 'modal/wams_upload_single.php', 'modal/wams_view_photo.php' template files
  - Fixed: Custom emails data "--- WAMS Email HTML Templates ---" in Install info

= 2.6.3: June 14, 2023 =

* Enhancements:

  - Added: `wams_profile_menu_link_{$id}_attrs` hook for changing link attributes
  ...
  - Added: New hooks `wams_profile_permalink`,`wams_external_profile_url`
  - Added: Users dropdown field to Admin Forms class
  - Added: Spotify URL field type
  - Added: New developer docs [here](http://wams.github.io/wams/). It will be upgraded from version to version
...
* Bugfixes:
  ...
  - Fixed: ACF and WAMS blocks conflict
  - Fixed: `WAMS()->mail()->locate_template()` function's visibility

* Deprecated:

  - Deprecated: `wams_localize_permalink_filter`. Use `post_link` instead
...
* Enhancements:
  ...
  - Added: 'wams_email_get_template_file_path' hook
...
* Bugfixes:
  ...
  - Fixed: Added wpnonce attribute for duplicate WAMS Form link
...
* Enhancements:
  ...
  - Added: Hook arguments ($form_id, $not_searched) to 'wams_members_directory_head'
  - Added: Using user locale `get_user_locale()` for localization with the 1st priority
  - Added: Hooks to change the profile SEO image: 'wams_profile_dynamic_meta_image_size', 'wams_profile_dynamic_meta_image_type'
  - Added: Filter for making 3rd-party roles editable through WAMS interfaces. Use 'wams_extend_editable_roles' and pass there an array of role keys( e.g. 'editor', 'administrator', etc. )
...
* Enhancements:
  ...
  - Added: 'wams_get_field_date' hook for filtering date fields
  - Added: `WAMS()->get_allowed_html()` function for using it inside wp_kses allowed HTML tags
...
* Enhancements:
  ...
  - Added: `wams_custom_authenticate_error_codes` hook for handling 3rd-party login errors on WAMS invalid form

* Bugfixes:

  - Fixed: Some texts sanitizing
  - Fixed: PHP Error in url-type field on WAMS Forms
...
* Enhancements:
  ...
  - Added: Custom fields callbacks blacklist. Use `wams_dropdown_options_source_blacklist` filter for adding your custom functions to the custom callbacks blacklist. By default there are all PHP internal functions.
...
* Bugfixes:
  ...
  - Fixed: Disable auto-login after user is registered by Administrator and WAMS Registration form
...
* Deprecated:
  ...
  - Removed: Outdated setting using in code (force_display_name_capitlized). Moved the functionality to extended [repo](https://github.com/wams/Extended/tree/main/um-capitalize-name#readme)
...
* Bugfixes:
  ...
  - Fixed: Password Reset process via WAMS - Password Reset form. Reset password links' arguments changed to the same view as WordPress native has. Password Reset available for the same cases as native WordPress Password Reset has
...
* Deprecated:
  ...
  - `WAMS()->query()->get_users_by_status()` without alternativities. It's unused since 2.5.0. Will be removed since 2.7.0
  - `WAMS()->user()->get_pending_users_count()`. Use `WAMS()->query()->get_pending_users_count()` instead. It's unused since 2.5.0. Will be removed since 2.7.0
  - `WAMS()->user()->remove_cached_queue()` without alternativities. It's unused since 2.5.0. Will be removed since 2.7.0
...
* Enhancements:
  ...
  - Added: Number-type WAMS custom fields to the list of the sorting fields on the member directory

* Bugfixes:

  - Fixed: XSS issue related to the JS confirmation and links with JS code inside
  - Fixed: PHP error when `wams_options` option in wp_options table doesn't exist or has wrong format
  ...
  - Fixed: Deleting `wams_member_directory_data` user meta when user is deleted
  ...
  - Fixed: Changed hook for member directory variables initialization for getting ability to use WAMS hooks for customizing these variables via theme
...
* Bugfixes:
  ...
  - Fixed: Security issue related to the [wams_loggedin] shortcode
...
* Enhancements:
  ...
  - Added: Users dropdown field for WAMS settings fields in wp-admin. It supports AJAX lazy loading
...
* Bugfixes:
  ...
  - Fixed: Removing WAMS custom capabilities from global $wp_roles when uninstall
  - Fixed: Removing WAMS custom roles from user roles after uninstall
...
* Deprecated:
  ...
  - `wams_whitelisted_wpadmin_access` hook and `wpadmin_allow_ips` option. They were unused and redundant since the 2.x version
...
* Enhancements:
  ...
  - Added: UM-specific query_var for WAMS additional Users_Query on users.php screen in wp-admin. `wams_custom_user_query` = true
  ...
  - Removed: `wams_check_extensions_licenses` and replaced it to `wams_daily_scheduled_events` event
...
* Bugfixes:
  ...
  - Fixed: PHP warning related to the WAMS custom fields without type
...
* Enhancements:
  ...
  - Added: 'wams_account_active_tab_inited' JS hook.
  - Updated: Require a strong password option (`WAMS > Settings > General > Users > Require a strong password?`) to make it common for all WAMS forms. Renamed option key from `reset_require_strongpass` to `require_strongpass`.
  - Updated: Form errors texts on the login/password reset forms. Made them secure.
  - Deprecated: `WAMS > Settings > General > Account > Require a strong password?` option and merged with `WAMS > Settings > General > Users > Require a strong password?` option.

* Bugfixes:

  - Fixed: "Clear All" button for the filters with "&" symbol in the label.
  - Fixed: Uninstall process when delete WAMS data. Avoid the issue when 3rd-party pages that had been selected as WAMS page are removed on WAMS uninstall.
  ...
  - Fixed: `WAMS()->clean_array()` function.
...
* Enhancements:
  ...
  - Added: Settings for the password min/max length (WAMS > Settings > Users)
...
* Enhancements:
  ...
  - Added: 'wams_ignore_restricted_title' hook for workaround show post title of the restricted post
...
* Bugfixes:
  ...
  - Fixed: `wams_edit_profile_url()`` function and added $user_id attribute
...
* Enhancements:
  ...
  - Added: Sanitizing handlers to the WAMS > Settings forms' fields
  - Added: Sanitizing handlers to the WAMS > User Role Add/Edit forms' fields
  - Added: Sanitizing handlers to the WAMS > Forms forms' fields
  - Added: Sanitizing handlers to the WAMS > Forms > Add Field/Edit Field forms' fields
  - Added: Sanitizing handlers to the WAMS > User Roles forms' fields
...
* Bugfixes:
  ...
  - Fixed: Saving and displaying settings on the WAMS > Settings > Access screen
...
* Enhancements:
  - Added: `wams_scripts.max_upload_size` localized variable getting from `wp_max_upload_size()`
...
* Enhancements:
  - Added: Hook `wams_registration_for_loggedin_users` to unlock the ability to add new users through the registration form
  - Added: Filter hook 'wams_change_usermeta_for_update' for extending `$to_update` usermeta array after all profile fields validations
  - Added: Filter hook 'wams_profile_tabs_privacy_list' and 'wams_profile_menu_can_view_tab' for extending privacy options for Profile Tabs
...
* Enhancements:
  ...
  - Added: Hooks `wams_before_email_notification_sending` and `wams_after_email_notification_sending` regarding #743 pull-request
...
* Bugfixes:
  ...
  - Fixed: The conflict with [Disable Blog](https://wordpress.org/plugins/disable-blog/) plugin regarding this [issue](https://wordpress.org/support/topic/wams-file-image-download/). `download_routing` callback has the highest priority now.
  - Fixed: Fields privacy functionality. This function `wams_can_view_field()` has been rewritten (#780)
...
* Enhancements:
  ...
  - Added: `wams_prepare_user_results_array_meta` hook and the 2nd argument for `wams_prepare_user_results_array` hook for handle $user_ids based on getting members query
...
* Bugfixes:
  ...
  - Fixed: Using myCRED points metakeys in WAMS usermeta table
  ...
  - Fixed: Displaying more than 1 WAMS popups on the same page
  - Fixed: WAMS dropdown.js position calculation
...
* Bugfixes:
  - Added third parameter $args to the action hook for Profile Tab redirections `wams_user_after_updating_profile`
...
* Enhancements:
  ...
  - Added: `wams_member_directory_cover_image_size` hook with ability to change the cover photo size on the member directory
  - Added: `wams_member_directory_avatar_image_size` hook with ability to change the profile photo size on the member directory
  - Added: `wams_member_directory_get_members_allow` JS hook for 3rd-party integration with the member directory. You could use a time throttle until some data is loaded
...
* Bugfixes:
  ...
  - Fixed: Vulnerability with timestamp field on WAMS Forms (the hidden field with name='timestamp' is deprecated)
...
* Bugfixes:
  ...
  - Fixed security patch for WAMS forms handlers
...
* Enhancements:
  ...
  - Deprecated the Feed widget from WAMS dashboard
...
* Enhancements:
  ...
  - Added dependency functions for extensions: [WAMS - User Notes](https://wams.com/extensions/user-notes/) & [WAMS - Profile Tabs](https://wams.com/extensions/profile-tabs/)
  - Added unique IDs to the form fields at the Profile's view mode
  - Added restrictions for WP > Users list table based on WAMS Roles capabilities

* Bugfixes:

  - Removed additional slashes in the WAMS custom roles titles
...
* Enhancements:
  ...
  - Added dependency functions for plugins: [WAMS - JobBoardWP integration](https://wordpress.org/plugins/um-jobboardwp) & [JobBoardWP](https://wordpress.org/plugins/jobboardwp)
...
* Bugfixes:
  ...
  - Fixed updating WAMS roles metadata (WP capabilities section) when 3rd-party plugins update the caps for the WAMS roles
...
* Deprecated:
  ...
  - Deprecated JS event 'wams_before_modal_removed', use wp.hooks action 'wams_before_modal_removed' instead
...
* Enhancements:
  ...
  - Added filter to the field's privacy option for the 3rd-party integrations 'wams_field_privacy_options'
  ...
  - Added filter for the changing redirect after profile edited 'wams_update_profile_redirect_after'
...
* Bugfixes:
  ...
  - Fixed wp-login.php and WAMS login form validation/errors triggers when using email for login
  ...
  - Fixed SkypeID field
  - Fixed clickable links in the WAMS forms which are displayed in a modal window
...
* Bugfixes:
  ...
  - Fixed issues with "key => value" fields (dropdown + multiselect) if 'wams_select_options_pair' filter is used
  - Fixed social URLs validations
  - Fixed WAMS wrapper's visibility on add/edit user page (wp-admin)
  - Fixed jQuery-UI library images
  - Fixed vulnerability with sanitizing $_POST
  - Fixed last login order on member directories when WAMS metatable is turned on
...
* Bugfixes:
  ...
  - Fixed [wams_loggedin] shortcode render with htmlspecialchars_decode
  ...
  - Fixed wams_convert_tags for array-type values
...
* Bugfixes:
  ...
  - Fixed endless recursion in the function wams_check_conditions_on_submit()
...
* Enhancements:
  ...
  - Additional parameter 'user_id' to action hook 'wams_user_after_updating_profile'
  - Added ability to set profile/cover image sizes from WAMS -> General -> Uploads settings or Original size
  - Added ability edit cover photo HTML (e.g. for adding some HTML attributes. See how add srcset attribute based on all generated cover sizes [here](https://docs.wams.com/article/1519-change-cover-photo-html))
  - Added custom date format for Date Picker field
  - Added hook 'wams_show_meta_item_html' to customize user meta HTML at User Profile page
...
* Bugfixes:
  ...
  - Fixed function "wams_apply_conditions". An error appears with jQuery v2.1.3
...
* Bugfixes:
  ...
  - Fixed issue when WAMS Roles localized as object on Add/Edit User screen
  - Fixed PHP notices
...
* Bugfixes:
  - Fixed update process for not WAMS custom role
...
* Bugfixes:
  ...
  - Fixed WAMS Roles create/edit XSS security issue
  - Fixed XSS security issue on account upgrade

= 2.0.51: July 09, 2019 =

* Bugfixes:
  - Fixed WAMS Roles create/edit security issue
...
* Bugfixes:
  - Fixed issues with Gutenberg scripts and WAMS blocks
  - Security vulnerabilities on Profile/Registration submit and file/images uploading
...
* Bugfixes:
  ...
  - Extended integration for WAMS field value
  - wams_user function avoid loop when 'display name' and 'full name' used
...
* Enhancements:
  - Added Gutenberg blocks section with WAMS shortcodes
...
* Deprecated:
  - removed "WAMS_TEXTDOMAIN" constant
  - removed function WAMS()->get_ajax_route() for AJAX vulnerability fix
...
* Bugfixes:
  ...
  - Fixed "wams_" prefix for role data
...
* Enhancements:
  - Added an ability to filter user's profile slug "wams_change_user_profile_slug"
  - Added an ability to filter pages for exclude restriction content settings "wams_exclude_posts_from_privacy"
...
* Deprecated:
  - Filters "wams_before_user_upload", "wams_after_user_upload"
...
* Enhancements:
  ...
  - Added ability to dismiss some WAMS notices
...
* Enhancements:
  - Added WAMS dashboard widget for getting latest extension's upgrades
...
* Bugfixes:
  ...
  - Fixed PHP validation on submit WAMS Forms with conditional fields logic
...
* Bugfixes:
  ...
  - Fixed not WAMS roles, which start from "wams_" symbols
...
* Bugfixes:
  ...
  - Restored old CSS settings to "wams_old_settings.css"
  - Clean user's cache
...
* Bugfixes:
  - Fixed add rewrite rules for WAMS pages
...
* Bugfixes:
  ...
  - Fixed lost password URL in WAMS Login Form
...
* Enhancements:
  ...
  - Added uninstall.php file for delete permanently all WAMS settings
  - Added ability to register users without WP Registration enabled
  - Added visual integration WPML+WAMS email notifications
  ...
  - Changed WAMS Option View (deprecated/added options)
  - Changed WAMS Roles, optimized for WP native logic
...
* Bugfixes:
  ...
  - Fixed theme conflicts with WAMS js libraries
...
* Enhancements:
  - Add new filter hook `wams_add_user_frontend_submitted`
...
* Enhancements:
  * Adds new action hooks before and after WP_User_Query.
    * `wams_user_before_query`
    * `wams_user_after_query`
  ...
  * Adds new option to disable name fields in account page
    * `WAMS > Settings > Account > Disable First & Last Name fields`
  * Add new filters to modify upload base directories
    * `wams_multisite_upload_sites_directory`
    * `wams_multisite_upload_directory`
  * Adds new action hook in admin > user edit > WAMS to append any customisation
    * `wams_user_profile_section`
  * Adds H2 for WAMS section to Add/Edit User Form
...
* Bugfixes
  ...
  * Fix WP role synchronisation on WAMS role update
...
* Enhancements:
   ...
   * Adds new filter hook to modif the user avatar's alternate text.
       * `wams_avatar_image_alternate_text`
...
* Enhancements:
   * Add filter hook to disable secure account fields
      * `wams_account_secure_fields__enabled`
...
* Bugfixes
   ...
   * Fix WPML compatibility with WAMS logout
...
* Enhancements:
   * Adds new username and string validation filter hooks:
      * wams_validation_safe_username_regex
      * wams_validation_safe_string_regex
   * Adds new filter hook to modify conditional fields
      * wams_get_field__{$field_key}
...
* Enhancements:
  ...
  * Adds a filter hook `wams_allow_frontend_image_uploads` to allow profile and cover photo uploads on front-end pages.
  * Adds new filter hooks to modify image field data on upload:
      * `wams_image_handle_global__option`
      * `wams_image_handle_{$field}__option`
  * Adds a new filter hook to modify the redirection of non logged in users who visit the parent user page.
     * `wams_locate_user_profile_not_loggedin__redirect`
  * Improves generate dummies tool with `wp_remote_get`
  * Adds a new action hook for a new section in cover area:
     * `wams_cover_area_content`
  * Updates the English translation .po and .mo files.
  * Improves the shortcode `wams_show_content` to swap the `user_id` with the current profile.
...
* Enhancements:
  * Adds a new filter hook to modify the `cover photo` uri.
      * `wams_user_cover_photo_uri__filter`
* Bugfixes:
...
* Enhancements:
    ...
    * Adds a new option to disable generating profile slugs on every load of member directory pages.
         * Located in WAMS > Settings > Advanced > Stop generating profile slugs in member directory.
    ...
    * Adds new filter hook `wams_activate_url` to modify the account activation url.
    * Adds new filter hooks to modify first and last name cases
        * `wams_user_first_name_case`
        * `wams_user_last_name_case`
    * Adds new filter hooks to modify nonces of image and file uploads
        * `wams_file_upload_nonce`
        * `wams_image_upload_nonce`
...
* Bugfixes:
    ...
    * Fixes a bug to disable/enable WAMS profile cache
...
* Fixed: multiple select in WAMS settings
...
* Added: new filter hook: `wams_get_default_cover_uri_filter`
* Added: new filter hook: `wams_register_allow_nonce_verification`
* Added: new filter hook: `wams_get_option_filter__{$option_id}`
* Added: new filter hook: ` wams_profile_{$key}__filter`
* Added: new filter hook: `wams_profile_{$key}_empty__filter`
* Added: new filter hook `wams_enable_ajax_urls`
* Added: new filter hook `wams_field_checkbox_item_title`
...
* Added: new action hook 'wams_registration_after_auto_login'
...
= 1.3.59: June 17, 2016 =
* Added: filter 'wams_register_hidden_role_field'
...
* Added: filter 'wams_submit_form_error' for custom error messages
...
= 1.3.51: May 10, 2016 =
* Added: 'wams_form_fields_textarea_settings' filter
...
* Added: action hook 'wams_access_post_type' & 'wams_access_post_type_{current_page_type}' for current page type in access settings
...
* Fixed: shortcode within [wams_show_content] shortcode
...
* New: filter `wams_<field_type>_form_show_field` for display field
* New: shortcode: show custom content to specific role [wams_show_content roles='member'][/wams_show_content]
* New: 'not' attribute to [wams_show_content not='member,contributor'][/wams_show_content] shortcode
* Tweak: update masonry script
* Tweak: sql concatenate with prepare statement
* Fixed: remove notices
* Fixed: missing mCSB_buttons.png
* Fixed: set Gravatar default image as WAMS default image
...
* Fixed: Enable WPML support to all WAMS url/links
...
* Fixed: Remove duplicated method wams_convert_tags
...
* Fixed: display WAMS classes only in WAMS pages
...
* New: added filter to wams_get_core_page() function (for developers)
...
* New: function is_wams() checks if user is on WAMS page (developers)
...
* New: easily sync WAMS roles with WP roles with role settings
* New: first steps towards WPML compatibility
* New: option to show member results only If user has searched
* New: add .um-err class to WAMS form if the form contains errors
...
* Fixed: WAMS forms and elements not appearing in IE
...
* New: Important: Introduces the WAMS RESTful API
* Tweak: improved wams_user_ip() function
* Fixed: issue with invalid html on profile photo and cover photo

= 1.2.91: April 30, 2015 =

* New: added custom field validation support via hooks wams_custom_field_validation_{$hook}
...
* New: new action hook that runs when user role is changed wams_member_role_upgrade
* Fixed: bug/compatibility issue with caching WAMS roles data
...
* Tweak: WAMS admins can see unapproved users on front-end members directory
...
* New: adds automatic body class to WAMS core pages automatically
...
* New: addon to transfer BuddyPress profile photos to WAMS (user request)
...
* Fixed: uncommon php warning caused by wams_get_user_avatar_url() function
...
* New: added option to disable WAMS menu (fixes conflict with mega-menu on some themes/plugins)
...
* New: A more native dashboard for WAMS
...
* Fixed: issue with using WAMS role as search filter in directory
...
* Fixed: important JS conflict in admin when WAMS is active
...
* Fixed: admin js and css should are loaded in WAMS backend only
...
* New: added support for child templates to allow customizing the templates of plugin via theme or child theme. [See how](https://wams.com/codex/overriding-default-wams-profile-templates/)
...
* New: added option to redirect author archive to their WAMS profile automatically
...
* Fixed: Issue with account page permalink resolved - [view issue](https://wams.com/forums/topic/permalink-bug/)
* Fixed: Issue with conditional menu items showing for un-approved users resolved - [view issue](https://wams.com/forums/topic/registration/)
...
* New: new admin action hook 'wams_extend_admin_menu' to extend plugin administration menu
...
* New: added filter hook wams_whitelisted_wpadmin_access to control access to wp-admin login screens (for developers)
...
* New: wams_user_permissions_filter hook (for developer use)
