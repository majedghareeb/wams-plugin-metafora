...
! function (t) {
    ...
    V.cleanData = (n = V.cleanData, function (t) {
        ...
        return e || (e = i, i = V.Widget), Array.isArray(e) && (e = V.extend.apply(null, [{}].concat(e))), V.expr.pseudos[l.toLowerCase()] = function (t) {
            ...
            _proto: V.extend({}, e),
            _childConstructors: []
        }), (a = new i).options = V.widget.extend({}, a.options), V.each(e, function (e, s) {
            function n() {
        ...
        for (var e, i, s = r.call(arguments, 1), n = 0, a = s.length; n < a; n++)
            for (e in s[n]) i = s[n][e], o.call(s[n], e) && void 0 !== i && (V.isPlainObject(i) ? t[e] = V.isPlainObject(t[e]) ? V.widget.extend({}, t[e], i) : V.widget.extend({}, i) : t[e] = i);
        return t
    }, V.widget.bridge = function (a, e) {
        ...
        V.fn[a] = function (i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function () {
                var t, e = V.data(this, o);
                return "instance" === i ? (n = e, !1) : e ? "function" != typeof e[i] || "_" === i.charAt(0) ? V.error("no such method '" + i + "' for " + a + " widget instance") : (t = e[i].apply(e, s)) !== e && void 0 !== t ? (n = t && t.jquery ? n.pushStack(t.get()) : t, !1) : void 0 : V.error("cannot call methods on " + a + " prior to initialization; attempted to call method '" + i + "'")
            }) : n = void 0 : (s.length && (i = V.widget.extend.apply(null, [i].concat(s))), this.each(function () {
                var t = V.data(this, o);
                t ? (t.option(i || {}), t._init && t._init()) : V.data(this, o, new e(i, this))
            })), n
        }
        ...
        option: function (t, e) {
            ...
            if ("string" == typeof t)
                if (a = {}, t = (i = t.split(".")).shift(), i.length) {
                    for (s = a[t] = V.widget.extend({}, this.options[t]), n = 0; n < i.length - 1; n++) s[i[n]] = s[i[n]] || {}, s = s[i[n]];
        ...
        _classes: function (n) {
            ...
            function t(t, e) {
                for (var i, s = 0; s < t.length; s++) i = o.classesElementLookup[t[s]] || V(), i = n.add ? (function () {
                    var i = [];
                    n.element.each(function (t, e) {
                        V.map(o.classesElementLookup, function (t) {
                            return t
                        }).some(function (t) {
                            return t.is(e)
                        }) || i.push(e)
                ...
                }(), V(V.uniqueSort(i.get().concat(n.element.get())))) : V(i.not(n.element).get()), o.classesElementLookup[t[s]] = i, a.push(t[s]), e && n.classes[t[s]] && a.push(n.classes[t[s]])
            }
            return (n = V.extend({
        ...
        _on: function (n, a, t) {
            var o, r = this;
            "boolean" != typeof n && (t = a, a = n, n = !1), t ? (a = o = V(a), this.bindings = this.bindings.add(a)) : (t = a, a = this.element, o = this.widget()), V.each(t, function (t, e) {
                function i() {
        ...
        V.Widget.prototype["_" + a] = function (e, t, i) {
            var s, n = (t = "string" == typeof t ? {
                effect: t
            } : t) ? !0 !== t && "number" != typeof t && t.effect || o : a;
            "number" == typeof (t = t || {}) ? t = {
                duration: t
            }: !0 === t && (t = {}), s = !V.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), s && V.effects && V.effects.effect[n] ? e[a](t) : n !== a && e[n] ? e[n](t.duration, t.easing, i) : e.queue(function (t) {
                V(this)[a](), i && i.call(e[0]), t()
            })
        }
    });
    var s, k, x, a, l, h, u, c, D;
    V.widget;
    ...
    k = Math.max, x = Math.abs, a = /left|center|right/, l = /top|center|bottom/, h = /[\+\-]\d+(\.[\d]+)?%?/, u = /^\w+/, c = /%$/, D = V.fn.position, V.position = {
    ...
    }, V.fn.position = function (c) {
        if (!c || !c.of) return D.apply(this, arguments);
        var d, p, f, g, m, t, _ = "string" == typeof (c = V.extend({}, c)).of ? V(document).find(c.of) : V(c.of),
            v = V.position.getWithinInfo(c.within),
        ...
        return _[0].preventDefault && (c.at = "left top"), p = e.width, f = e.height, m = V.extend({}, g = e.offset), V.each(["my", "at"], function () {
            var t, e, i = (c[this] || "").split(" ");
            (i = 1 === i.length ? a.test(i[0]) ? i.concat(["center"]) : l.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = a.test(i[0]) ? i[0] : "center", i[1] = l.test(i[1]) ? i[1] : "center", t = h.exec(i[0]), e = h.exec(i[1]), w[this] = [t ? t[0] : 0, e ? e[0] : 0], c[this] = [u.exec(i[0])[0], u.exec(i[1])[0]]
        }), 1 === y.length && (y[1] = y[0]), "right" === c.at[0] ? m.left += p : "center" === c.at[0] && (m.left += p / 2), "bottom" === c.at[1] ? m.top += f : "center" === c.at[1] && (m.top += f / 2), d = C(w.at, p, f), m.left += d[0], m.top += d[1], this.each(function () {
            var i, t, o = V(this),
                r = o.outerWidth(),
                l = o.outerHeight(),
                e = T(this, "marginLeft"),
                ...
                a = l + s + T(this, "marginBottom") + b.height,
                h = V.extend({}, m),
            ...
            "right" === c.my[0] ? h.left -= r : "center" === c.my[0] && (h.left -= r / 2), "bottom" === c.my[1] ? h.top -= l : "center" === c.my[1] && (h.top -= l / 2), h.left += u[0], h.top += u[1], i = {
                ...
                p < r && x(e + i) < p && (a.horizontal = "center"), f < l && x(s + n) < f && (a.vertical = "middle"), k(x(e), x(i)) > k(x(s), x(n)) ? a.important = "horizontal" : a.important = "vertical", c.using.call(this, t, a)
            }), o.offset(V.extend(h, {
                using: t
            }))
        })
        ...
        fit: {
            left: function (t, e) {
                ...
                e.collisionWidth > n ? 0 < o && r <= 0 ? (i = t.left + o + e.collisionWidth - n - s, t.left += o - i) : t.left = !(0 < r && o <= 0) && r < o ? s + n - e.collisionWidth : s : 0 < o ? t.left += o : 0 < r ? t.left -= r : t.left = k(t.left - a, t.left)
            },
            top: function (t, e) {
                var i = e.within,
                ...
                e.collisionHeight > n ? 0 < o && r <= 0 ? (i = t.top + o + e.collisionHeight - n - s, t.top += o - i) : t.top = !(0 < r && o <= 0) && r < o ? s + n - e.collisionHeight : s : 0 < o ? t.top += o : 0 < r ? t.top -= r : t.top = k(t.top - a, t.top)
            }
        },
        flip: {
            left: function (t, e) {
    ...
    V.ui.focusable = function (t, e) {
        ...
        return "area" === o ? (s = (i = t.parentNode).name, !(!t.href || !s || "map" !== i.nodeName.toLowerCase()) && (0 < (s = V("img[usemap='#" + s + "']")).length && s.is(":visible"))) : (/^(input|select|textarea|button|object)$/.test(o) ? (n = !t.disabled) && (a = V(t).closest("fieldset")[0]) && (n = !a.disabled) : n = "a" === o && t.href || e, n && V(t).is(":visible") && function (t) {
    ...
    V.widget("ui.mouse", {
        ...
        _mouseUp: function (t) {
            this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, t.target === this._mouseDownEvent.target && V.data(t.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(t)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, d = !1, t.preventDefault()
        },
    ...
    V.widget("ui.draggable", V.ui.mouse, {
        ...
        drag: function (t, e, i) {
            for (var s, n, a, o, r, l, h, u, c, d = i.options, p = d.snapTolerance, f = e.offset.left, g = f + i.helperProportions.width, m = e.offset.top, _ = m + i.helperProportions.height, v = i.snapElements.length - 1; 0 <= v; v--) l = (r = i.snapElements[v].left - i.margins.left) + i.snapElements[v].width, u = (h = i.snapElements[v].top - i.margins.top) + i.snapElements[v].height, g < r - p || l + p < f || _ < h - p || u + p < m || !V.contains(i.snapElements[v].item.ownerDocument, i.snapElements[v].item) ? (i.snapElements[v].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, V.extend(i._uiHash(), {
            ...
            })), i.snapElements[v].snapping = !1) : ("inner" !== d.snapMode && (s = Math.abs(h - _) <= p, n = Math.abs(u - m) <= p, a = Math.abs(r - g) <= p, o = Math.abs(l - f) <= p, s && (e.position.top = i._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left)), c = s || n || a || o, "outer" !== d.snapMode && (s = Math.abs(h - m) <= p, n = Math.abs(u - _) <= p, a = Math.abs(r - f) <= p, o = Math.abs(l - g) <= p, s && (e.position.top = i._convertPositionTo("relative", {
                top: h,
                left: 0
            }).top), n && (e.position.top = i._convertPositionTo("relative", {
            ...
            }).left)), !i.snapElements[v].snapping && (s || n || a || o || c) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, V.extend(i._uiHash(), {
                snapItem: i.snapElements[v].item
    ...
    V.widget("ui.resizable", V.ui.mouse, {
        ...
        _setupHandles: function () {
            var t, e, i, s, n, a = this.options,
                o = this;
            if (this.handles = a.handles || (V(".ui-resizable-handle", this.element).length ? {
                    n: ".ui-resizable-n",
                    e: ".ui-resizable-e",
                    s: ".ui-resizable-s",
                    w: ".ui-resizable-w",
        ...
        _mouseStop: function (t) {
            ...
            }, i = parseFloat(a.element.css("left")) + (a.position.left - a.originalPosition.left) || null, s = parseFloat(a.element.css("top")) + (a.position.top - a.originalPosition.top) || null, n.animate || this.element.css(V.extend(e, {
                top: s,
                left: i
            })), a.helper.height(a.size.height), a.helper.width(a.size.width), this._helper && !n.animate && this._proportionallyResize()), V("body").css("cursor", "auto"), this._removeClass("ui-resizable-resizing"), this._propagate("stop", t), this._helper && this.helper.remove(), !1
        },
        ...
        start: function () {
            var i, s, n = V(this).resizable("instance"),
                ...
                e = n.element,
                a = t.containment,
                o = a instanceof V ? a.get(0) : /parent/.test(a) ? e.parent().get(0) : a;
            o && (n.containerElement = V(o), /document/.test(a) || a === document ? (n.containerOffset = {
                left: 0,
                top: 0
            }, n.containerPosition = {
                left: 0,
            ...
            }) : (i = V(o), s = [], V(["Top", "Right", "Left", "Bottom"]).each(function (t, e) {
    ...
    V.ui.resizable, V.widget("ui.accordion", {
        ...
        _animate: function (t, i, e) {
            ...
            return n = (n = "string" == typeof c ? c : n) || c.easing || u.easing, a = (a = "number" == typeof c ? c : a) || c.duration || u.duration, i.length ? t.length ? (s = t.show().outerHeight(), i.animate(this.hideProps, {
                duration: a,
                easing: n,
                step: function (t, e) {
                    e.now = Math.round(t)
    ...
    V.widget("ui.controlgroup", {
        ...
        _initWidgets: function () {
            ...
            V.each(this.options.items, function (s, t) {
                ...
                }), a._addClass(e, null, "ui-widget ui-widget-content ui-state-default"), void(o = o.concat(e.get()))) : void(V.fn[s] && (n = a["_" + s + "Options"] ? a["_" + s + "Options"]("middle") : {
                    classes: {}
                }, a.element.find(t).each(function () {
                    var t = V(this),
                        e = t[s]("instance"),
                        i = V.widget.extend({}, n);
                    "button" === s && t.parent(".ui-spinner").length || ((e = e || t[s]()[s]("instance")) && (i.classes = a._resolveClassesValues(i.classes, e)), t[s](i), i = t[s]("widget"), V.data(i[0], "ui-controlgroup-data", e || t[s]("instance")), o.push(i[0]))
                })))
            }), this.childWidgets = V(V.uniqueSort(o)), this._addClass(this.childWidgets, "ui-controlgroup-item")
        },
        ...
        _resolveClassesValues: function (i, s) {
            ...
            return V.each(i, function (t) {
                var e = s.options.classes[t] || "",
                    e = String.prototype.trim.call(e.replace(p, ""));
    ...
    }), V.fn.button = (f = V.fn.button, function (i) {
        var t = "string" == typeof i,
    ...
    function m() {
        this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = {
            ...
            autoSize: !1,
            disabled: !1
        }, V.extend(this._defaults, this.regional[""]), this.regional.en = V.extend(!0, {}, this.regional[""]), this.regional["en-US"] = V.extend(!0, {}, this.regional.en), this.dpDiv = _(V("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    ...
    function v() {
        V.datepicker._isDisabledDatepicker((g.inline ? g.dpDiv.parent() : g.input)[0]) || (V(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), V(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") && V(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") && V(this).addClass("ui-datepicker-next-hover"))
    }
    ...
    V.extend(V.ui, {
        ...
        _newInst: function (t, e) {
            return {
                ...
                drawYear: 0,
                inline: e,
                dpDiv: e ? _(V("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv
            }
        },
        ...
        _dialogDatepicker: function (t, e, i, s, n) {
            ...
            return o || (this.uuid += 1, a = "dp" + this.uuid, this._dialogInput = V("<input type='text' id='" + a + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.on("keydown", this._doKeyDown), V("body").append(this._dialogInput), (o = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, V.data(this._dialogInput[0], "datepicker", o)), b(o.settings, s || {}), e = e && e.constructor === Date ? this._formatDate(o, e) : e, this._dialogInput.val(e), this._pos = n ? n.length ? n : [n.pageX, n.pageY] : null, this._pos || (a = document.documentElement.clientWidth, s = document.documentElement.clientHeight, e = document.documentElement.scrollLeft || document.body.scrollLeft, n = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [a / 2 - 100 + e, s / 2 - 150 + n]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), o.settings.onSelect = i, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), this._showDatepicker(this._dialogInput[0]), V.blockUI && V.blockUI(this.dpDiv), V.data(this._dialogInput[0], "datepicker", o), this
        },
        ...
        _optionDatepicker: function (t, e, i) {
            ...
            if (2 === arguments.length && "string" == typeof e) return "defaults" === e ? V.extend({}, V.datepicker._defaults) : a ? "all" === e ? V.extend({}, a.settings) : this._get(a, e) : null;
            s = e || {}, "string" == typeof e && ((s = {})[e] = i), a && (this._curInst === a && this._hideDatepicker(), n = this._getDateDatepicker(t, !0), e = this._getMinMaxDate(a, "min"), i = this._getMinMaxDate(a, "max"), b(a.settings, s), null !== e && void 0 !== s.dateFormat && void 0 === s.minDate && (a.settings.minDate = this._formatDate(a, e)), null !== i && void 0 !== s.dateFormat && void 0 === s.maxDate && (a.settings.maxDate = this._formatDate(a, i)), "disabled" in s && (s.disabled ? this._disableDatepicker(t) : this._enableDatepicker(t)), this._attachments(V(t), a), this._autoSize(a), this._setDate(a, n), this._updateAlternate(a), this._updateDatepicker(a))
        },
        ...
        _doKeyDown: function (t) {
            ...
            if (s._keyEvent = !0, V.datepicker._datepickerShowing) switch (t.keyCode) {
                ...
                case 36:
                    ...
                    break;
                case 37:
                    (t.ctrlKey || t.metaKey) && V.datepicker._adjustDate(t.target, a ? 1 : -1, "D"), n = t.ctrlKey || t.metaKey, t.originalEvent.altKey && V.datepicker._adjustDate(t.target, t.ctrlKey ? -V.datepicker._get(s, "stepBigMonths") : -V.datepicker._get(s, "stepMonths"), "M");
                    break;
                case 38:
        ...
        _updateDatepicker: function (t) {
            ...
            var e, i = this._getNumberOfMonths(t),
                ...
                a = V.datepicker._get(t, "onUpdateDatepicker");
        ...
        _checkOffset: function (t, e, i) {
            ...
            return e.left -= this._get(t, "isRTL") ? s - a : 0, e.left -= i && e.left === t.input.offset().left ? V(document).scrollLeft() : 0, e.top -= i && e.top === t.input.offset().top + o ? V(document).scrollTop() : 0, e.left -= Math.min(e.left, e.left + s > r && s < r ? Math.abs(e.left + s - r) : 0), e.top -= Math.min(e.top, e.top + n > l && n < l ? Math.abs(n + o) : 0), e
        },
        _findPos: function (t) {
        ...
        parseDate: function (e, n, t) {
            ...
            for (var i, s, a, o = 0, r = (t ? t.shortYearCutoff : null) || this._defaults.shortYearCutoff, r = "string" != typeof r ? r : (new Date).getFullYear() % 100 + parseInt(r, 10), l = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, h = (t ? t.dayNames : null) || this._defaults.dayNames, u = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, c = (t ? t.monthNames : null) || this._defaults.monthNames, d = -1, p = -1, f = -1, g = -1, m = !1, _ = function (t) {
                    ...
                    if (n.charAt(o) !== e.charAt(w)) throw "Unexpected literal at position " + o;
                    o++
                }, w = 0; w < e.length; w++)
        ...
        _determineDate: function (r, t, e) {
            var i, s, t = null == t || "" === t ? e : "string" == typeof t ? function (t) {
                ...
                for (var e = (t.toLowerCase().match(/^c/) ? V.datepicker._getDate(r) : null) || new Date, i = e.getFullYear(), s = e.getMonth(), n = e.getDate(), a = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, o = a.exec(t); o;) {
                    switch (o[2] || "d") {
                        case "d":
                        case "D":
                            n += parseInt(o[1], 10);
                        ...
                        case "m":
                        case "M":
                            s += parseInt(o[1], 10), n = Math.min(n, V.datepicker._getDaysInMonth(i, s));
                            break;
                        case "y":
                        case "Y":
                            i += parseInt(o[1], 10), n = Math.min(n, V.datepicker._getDaysInMonth(i, s))
                    }
                    o = a.exec(t)
                }
        ...
        _generateHTML: function (t) {
            var e, i, s, n, a, o, r, l, h, u, c, d, p, f, g, m, _, v, b, y, w, k, x, D, C, T, M, I, S, P, z, A, O = new Date,
                E = this._daylightSavingAdjust(new Date(O.getFullYear(), O.getMonth(), O.getDate())),
                H = this._get(t, "isRTL"),
                ...
                U = t.drawYear;
            if (q < 0 && (q += 12, U--), K)
                for (e = this._daylightSavingAdjust(new Date(K.getFullYear(), K.getMonth() - R[0] * R[1] + 1, K.getDate())), e = j && e < j ? j : e; this._daylightSavingAdjust(new Date(U, q, 1)) > e;) --q < 0 && (q = 11, U--);
            for (t.drawMonth = q, t.drawYear = U, L = this._get(t, "prevText"), L = F ? this.formatDate(L, this._daylightSavingAdjust(new Date(U, q - O, 1)), this._getFormatConfig(t)) : L, i = this._canAdjustMonth(t, -1, U, q) ? V("<a>").attr({
                    class: "ui-datepicker-prev ui-corner-all",
                    "data-handler": "prev",
                    "data-event": "click",
                    title: L
                }).append(V("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (H ? "e" : "w")).text(L))[0].outerHTML : W ? "" : V("<a>").attr({
                    class: "ui-datepicker-prev ui-corner-all ui-state-disabled",
                    title: L
                }).append(V("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (H ? "e" : "w")).text(L))[0].outerHTML, L = this._get(t, "nextText"), L = F ? this.formatDate(L, this._daylightSavingAdjust(new Date(U, q + O, 1)), this._getFormatConfig(t)) : L, s = this._canAdjustMonth(t, 1, U, q) ? V("<a>").attr({
                    class: "ui-datepicker-next ui-corner-all",
                    "data-handler": "next",
                    "data-event": "click",
                    title: L
                }).append(V("<span>").addClass("ui-icon ui-icon-circle-triangle-" + (H ? "w" : "e")).text(L))[0].outerHTML : W ? "" : V("<a>").attr({
                    class: "ui-datepicker-next ui-corner-all ui-state-disabled",
                    title: L
                }).append(V("<span>").attr("class", "ui-icon ui-icon-circle-triangle-" + (H ? "w" : "e")).text(L))[0].outerHTML, O = this._get(t, "currentText"), W = this._get(t, "gotoCurrent") && t.currentDay ? B : E, O = F ? this.formatDate(O, W, this._getFormatConfig(t)) : O, L = "", t.inline || (L = V("<button>").attr({
                    type: "button",
                    class: "ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all",
                    "data-handler": "hide",
                    "data-event": "click"
                }).text(this._get(t, "closeText"))[0].outerHTML), F = "", N && (F = V("<div class='ui-datepicker-buttonpane ui-widget-content'>").append(H ? L : "").append(this._isInRange(t, W) ? V("<button>").attr({
                    type: "button",
                    class: "ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all",
                    "data-handler": "today",
                    "data-event": "click"
                }).text(O) : "").append(H ? "" : L)[0].outerHTML), n = parseInt(this._get(t, "firstDay"), 10), n = isNaN(n) ? 0 : n, a = this._get(t, "showWeek"), o = this._get(t, "dayNames"), r = this._get(t, "dayNamesMin"), l = this._get(t, "monthNames"), h = this._get(t, "monthNamesShort"), u = this._get(t, "beforeShowDay"), c = this._get(t, "showOtherMonths"), d = this._get(t, "selectOtherMonths"), p = this._getDefaultDate(t), f = "", m = 0; m < R[0]; m++) {
                for (_ = "", this.maxRows = 4, v = 0; v < R[1]; v++) {
                    if (b = this._daylightSavingAdjust(new Date(U, q, t.selectedDay)), y = " ui-corner-all", w = "", Y) {
                    ...
                    for (w += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + y + "'>" + (/all|left/.test(y) && 0 === m ? H ? s : i : "") + (/all|right/.test(y) && 0 === m ? H ? i : s : "") + this._generateMonthYearHeader(t, q, U, j, K, 0 < m || 0 < v, l, h) + "</div><table class='ui-datepicker-calendar'><thead><tr>", k = a ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", g = 0; g < 7; g++) k += "<th scope='col'" + (5 <= (g + n + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + o[x = (g + n) % 7] + "'>" + r[x] + "</span></th>";
                    for (w += k + "</tr></thead><tbody>", C = this._getDaysInMonth(U, q), U === t.selectedYear && q === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, C)), D = (this._getFirstDayOfMonth(U, q) - n + 7) % 7, C = Math.ceil((D + C) / 7), T = Y && this.maxRows > C ? this.maxRows : C, this.maxRows = T, M = this._daylightSavingAdjust(new Date(U, q, 1 - D)), I = 0; I < T; I++) {
                        for (w += "<tr>", S = a ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(M) + "</td>" : "", g = 0; g < 7; g++) P = u ? u.apply(t.input ? t.input[0] : null, [M]) : [!0, ""], A = (z = M.getMonth() !== q) && !d || !P[0] || j && M < j || K && K < M, S += "<td class='" + (5 <= (g + n + 6) % 7 ? " ui-datepicker-week-end" : "") + (z ? " ui-datepicker-other-month" : "") + (M.getTime() === b.getTime() && q === t.selectedMonth && t._keyEvent || p.getTime() === M.getTime() && p.getTime() === b.getTime() ? " " + this._dayOverClass : "") + (A ? " " + this._unselectableClass + " ui-state-disabled" : "") + (z && !c ? "" : " " + P[1] + (M.getTime() === B.getTime() ? " " + this._currentClass : "") + (M.getTime() === E.getTime() ? " ui-datepicker-today" : "")) + "'" + (z && !c || !P[2] ? "" : " title='" + P[2].replace(/'/g, "&#39;") + "'") + (A ? "" : " data-handler='selectDay' data-event='click' data-month='" + M.getMonth() + "' data-year='" + M.getFullYear() + "'") + ">" + (z && !c ? "&#xa0;" : A ? "<span class='ui-state-default'>" + M.getDate() + "</span>" : "<a class='ui-state-default" + (M.getTime() === E.getTime() ? " ui-state-highlight" : "") + (M.getTime() === B.getTime() ? " ui-state-active" : "") + (z ? " ui-priority-secondary" : "") + "' href='#' aria-current='" + (M.getTime() === B.getTime() ? "true" : "false") + "' data-date='" + M.getDate() + "'>" + M.getDate() + "</a>") + "</td>", M.setDate(M.getDate() + 1), M = this._daylightSavingAdjust(M);
                        w += S + "</tr>"
                    }
                    11 < ++q && (q = 0, U++), _ += w += "</tbody></table>" + (Y ? "</div>" + (0 < R[0] && v === R[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                f += _
            }
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, a, o, r) {
            var l, h, u, c, d, p, f = this._get(t, "changeMonth"),
                ...
                y = "";
            if (a || !f) y += "<span class='ui-datepicker-month'>" + o[e] + "</span>";
            else {
            ...
            if (m || (b += y + (!a && f && g ? "" : "&#xa0;")), !t.yearshtml)
                ...
                } return b += this._get(t, "yearSuffix"), m && (b += (!a && f && g ? "" : "&#xa0;") + y), b += "</div>"
        },
    ...
    }, V.datepicker = new m, V.datepicker.initialized = !1, V.datepicker.uuid = (new Date).getTime(), V.datepicker.version = "1.13.2";
    V.datepicker;
    V.widget("ui.dialog", {
        version: "1.13.2",
        options: {
        ...
        _makeDraggable: function () {
            ...
            this.uiDialog.draggable({
                ...
                start: function (t, e) {
                    n._addClass(V(this), "ui-dialog-dragging"), n._blockFrames(), n._trigger("dragStart", t, o(e))
                },
                drag: function (t, e) {
                ...
                stop: function (t, e) {
                    ...
                    a.position = {
                        ...
                        of: n.window
                    }, n._removeClass(V(this), "ui-dialog-dragging"), n._unblockFrames(), n._trigger("dragStop", t, o(e))
                }
            })
        },
        _makeResizable: function () {
            ...
            this.uiDialog.resizable({
                ...
                handles: t,
                start: function (t, e) {
                    n._addClass(V(this), "ui-dialog-resizing"), n._blockFrames(), n._trigger("resizeStart", t, o(e))
                },
                resize: function (t, e) {
                ...
                stop: function (t, e) {
                    ...
                    a.height = n.uiDialog.height(), a.width = n.uiDialog.width(), a.position = {
                        ...
                        of: n.window
                    }, n._removeClass(V(this), "ui-dialog-resizing"), n._unblockFrames(), n._trigger("resizeStop", t, o(e))
                }
            }).css("position", e)
        },
    ...
    V.ui.dialog, V.widget("ui.progressbar", {
        ...
        _mouseCapture: function (t) {
            ...
            return !l.disabled && (this.elementSize = {
                ...
                (e < s || s === e && (t === r._lastChangedValue || r.values(t) === l.min)) && (s = e, n = V(this), a = t)
            }), !1 !== this._start(t, a) && (this._mouseSliding = !0, this._handleIndex = a, this._addClass(n, null, "ui-state-active"), n.trigger("focus"), e = n.offset(), o = !V(t.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = o ? {
                left: 0,
                top: 0
            } : {
        ...
        _refreshValue: function () {
            ...
            this._hasMultipleValues() ? this.handles.each(function (t) {
                i = (r.values(t) - r._valueMin()) / (r._valueMax() - r._valueMin()) * 100, h["horizontal" === r.orientation ? "left" : "bottom"] = i + "%", V(this).stop(1, 1)[l ? "animate" : "css"](h, o.animate), !0 === r.options.range && ("horizontal" === r.orientation ? (0 === t && r.range.stop(1, 1)[l ? "animate" : "css"]({
                    left: i + "%"
    ...
    V.widget("ui.tabs", {
        ...
        _processTabs: function () {
            ...
            this.tablist = this._getList().attr("role", "tablist"), this._addClass(this.tablist, "ui-tabs-nav", "ui-helper-reset ui-helper-clearfix ui-widget-header"), this.tablist.on("mousedown" + this.eventNamespace, "> li", function (t) {
                ...
                var i, s, n, a = V(e).uniqueId().attr("id"),
                    o = V(e).closest("li"),
                    r = o.attr("aria-controls");
                l._isLocal(e) ? (n = (i = e.hash).substring(1), s = l.element.find(l._sanitizeSelector(i))) : (n = o.attr("aria-controls") || V({}).uniqueId()[0].id, (s = l.element.find(i = "#" + n)).length || (s = l._createPanel(n)).insertAfter(l.panels[t - 1] || l.tablist), s.attr("aria-live", "polite")), s.length && (l.panels = l.panels.add(s)), r && o.data("ui-tabs-aria-controls", r), o.attr({
                    "aria-controls": n,
                    "aria-labelledby": a
        ...
        _eventHandler: function (t) {
            ...
            t.preventDefault(), s.hasClass("ui-state-disabled") || s.hasClass("ui-tabs-loading") || this.running || n && !e.collapsible || !1 === this._trigger("beforeActivate", t, i) || (e.active = !a && this.tabs.index(s), this.active = n ? V() : s, this.xhr && this.xhr.abort(), r.length || o.length || V.error("jQuery UI Tabs: Mismatching fragment identifier."), o.length && this.load(this.tabs.index(s), t), this._toggle(t, i))
        },
        ...
        load: function (t, s) {
            ...
            this._isLocal(t[0]) || (this.xhr = V.ajax(this._ajaxSettings(t, s, r)), this.xhr && "canceled" !== this.xhr.statusText && (this._addClass(i, "ui-tabs-loading"), o.attr("aria-busy", "true"), this.xhr.done(function (t, e, i) {
                setTimeout(function () {
    ...
    V.widget("ui.tooltip", {
        ...
        _open: function (t, e, i) {
            var s, n, a, o = V.extend({}, this.options.position);
