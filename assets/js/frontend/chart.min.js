...
! function (t, e) {
    ...
    const Nt = /^rgba?\(\s*([-+.\d]+)(%)?[\s,]+([-+.e\d]+)(%)?[\s,]+([-+.e\d]+)(%)?(?:[\s,/]+([-+.e\d]+)(%)?)?\s*\)$/,
        Wt = t => t <= .0031308 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055,
    ...
    class Xt {
        constructor(t) {
            ...
            "object" === e ? i = Yt(t) : "string" === e && (o = (s = t).length, "#" === s[0] && (4 === o || 5 === o ? n = {
                ...
                Bt || (Bt = function () {
                    ...
                    for (s = 0; s < e.length; s++) {
                        for (a = r = e[s], n = 0; n < i.length; n++) o = i[n], r = r.replace(o, Ft[o]);
                        o = parseInt(Vt[a], 16), t[r] = [o >> 16 & 255, o >> 8 & 255, 255 & o]
                    }
                    return t
                }(), Bt.transparent = [0, 0, 0, 0]);
            ...
            }(t) || Ut(t)), this._rgb = i, this._valid = !!i
        }
        get valid() {
            return this._valid
        }
        ...
        interpolate(t, e) {
            return t && (this._rgb = function (t, e, i) {
                const s = Ht(Mt(t.r)),
                    ...
                    o = Ht(Mt(t.b));
                return {
                    r: vt(Wt(s + i * (Ht(Mt(e.r)) - s))),
                    g: vt(Wt(n + i * (Ht(Mt(e.g)) - n))),
                    b: vt(Wt(o + i * (Ht(Mt(e.b)) - o))),
                    a: t.a + i * (e.a - t.a)
                }
    ...
    function Kt(t) {
        return qt(t) ? t : new Xt(t)
    }

    function Gt(t) {
        return qt(t) ? t : new Xt(t).saturate(.5).darken(.1).hexString()
    }
    ...
    function ae(t, e, i) {
        return "string" == typeof e ? b(oe(t, e), i) : b(oe(t, ""), e)
    }
    var re = new class {
        constructor(t, e) {
    ...
    function pe(t, e) {
        ...
        } = e, n = de(i), o = "border-box" === n.boxSizing, a = ge(n, "padding"), r = ge(n, "border", "width"), {
            x: l,
            y: h,
            box: c
        } = function (t, e) {
    ...
    function be(t, e, i, s) {
        const n = de(t),
            o = ge(n, "margin"),
            a = ce(n.maxWidth, t, "clientWidth") || T,
            r = ce(n.maxHeight, t, "clientHeight") || T,
            l = function (t, e, i) {
                let s, n;
                if (void 0 === e || void 0 === i) {
                    ...
                    if (o) {
                        const t = o.getBoundingClientRect(),
                            ...
                            r = ge(a, "border", "width"),
                            l = ge(a, "padding");
                        e = t.width - l.width - r.width, i = t.height - l.height - r.height, s = ce(a.maxWidth, o, "clientWidth"), n = ce(a.maxHeight, o, "clientHeight")
        ...
        if ("content-box" === n.boxSizing) {
            const t = ge(n, "border", "width"),
                e = ge(n, "padding");
            h -= e.width + t.width, c -= e.height + t.height
        }
        return h = Math.max(0, h - o.width), c = Math.max(0, s ? h / s : c - o.height), h = me(Math.min(h, a, l.maxWidth)), c = me(Math.min(c, r, l.maxHeight)), h && !c && (c = me(h / 2)), (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && (c = l.height, h = me(Math.floor(c * s))), {
            width: h,
            height: c
        }
    }
    ...
    function we(t, e, i, s) {
        ...
        for (h = 0; h < l; h++)
            if (u = i[h], null == u || n(u)) {
                if (n(u))
                    for (c = 0, d = u.length; c < d; c++) f = u[c], null == f || n(f) || (r = Me(t, o, a, r, f))
            } else r = Me(t, o, a, r, u);
        t.restore();
        const g = a.length / 2;
        if (g > i.length) {
    ...
    function Ie(t, e, i, o, a, r = {}) {
        ...
        for (t.save(), t.font = a.string, function (t, e) {
            ...
            }(t, r), c = 0; c < l.length; ++c) d = l[c], r.backdrop && Re(t, r.backdrop), h && (r.strokeColor && (t.strokeStyle = r.strokeColor), s(r.strokeWidth) || (t.lineWidth = r.strokeWidth), t.strokeText(d, i, o, r.maxWidth)), t.fillText(d, i, o, r.maxWidth), Ee(t, i, o, d, r), o += Number(a.lineHeight);
        t.restore()
    }
    ...
    function Fe(t, e = [""], i, s, n = (() => t[0])) {
        ...
        const a = {
            ...
            _fallback: s,
            _getTarget: n,
            override: i => Fe([i, ...t], e, o, s)
        };
        return new Proxy(a, {
            deleteProperty: (e, i) => (delete e[i], delete e._keys, delete t[0][i], !0),
            get: (i, s) => He(i, s, (() => function (t, e, i, s) {
                let n;
                for (const o of e)
                    if (n = qe(Ne(o, t), i), void 0 !== n) return We(t, n) ? Ue(i, s, t, n) : n
            }(s, e, t, i))),
    ...
    function Ve(t, e, i, s) {
        const a = {
            ...
            _stack: new Set,
            _descriptors: Be(t, s),
            setContext: e => Ve(t, e, i, s),
            override: n => Ve(t.override(n), e, i, s)
        };
        return new Proxy(a, {
            deleteProperty: (e, i) => (delete e[i], delete t[i], !0),
            get: (t, e, i) => He(t, e, (() => function (t, e, i) {
                const {
                    _proxy: s,
                    _context: a,
                    _subProxy: r,
                ...
                let h = s[e];
                return S(h) && l.isScriptable(e) && (h = function (t, e, i, s) {
                    const {
                        _proxy: n,
                        _context: o,
                        _subProxy: a,
                    ...
                    r.add(t);
                    let l = e(o, a || s);
                    return r.delete(t), We(t, l) && (l = Ue(n._scopes, n, t, l)), l
                    ...
                    if (o(e[0])) {
                        ...
                        for (const o of i) {
                            const i = Ue(s, n, t, o);
                            e.push(Ve(i, a, r && r[t], l))
                        }
                    }
                    return e
                }(e, h, t, l.isIndexable)), We(e, h) && (h = Ve(h, a, r && r[e], l)), h
            }(t, e, i))),
    ...
    const Ne = (t, e) => t ? t + w(e) : e,
        We = (t, e) => o(e) && "adapters" !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
    ...
    const $e = (t, e) => !0 === t ? e : "string" == typeof t ? M(e, t) : void 0;
    ...
    function Ue(t, e, i, s) {
        const a = e._rootScopes,
            r = je(e._fallback, i, s),
            l = [...t, ...a],
            h = new Set;
        h.add(s);
        let c = Xe(h, l, i, r || i, s);
        return null !== c && (void 0 === r || r === i || (c = Xe(h, l, r, c, s), null !== c)) && Fe(Array.from(h), [""], a, r, (() => function (t, e, i) {
    ...
    function ei(t, e = "x") {
        ...
        function (t, e, i) {
            const s = t.length;
            let n, o, a, r, l, h = Je(t, 0);
            for (let c = 0; c < s - 1; ++c) l = h, h = Je(t, c + 1), l && h && (V(e[c], 0, Ze) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c], o = i[c + 1] / e[c], r = Math.pow(n, 2) + Math.pow(o, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[c] = n * a * e[c], i[c + 1] = o * a * e[c])))
        }(t, n, o),
        function (t, e, i = "x") {
            const s = Qe(i),
                n = t.length;
            let o, a, r, l = Je(t, 0);
            for (let h = 0; h < n; ++h) {
                if (a = r, r = l, l = Je(t, h + 1), !r) continue;
                const n = r[i],
                    c = r[s];
    ...
    function si(t, e, i, s, n) {
        ...
        if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) ei(t, n);
            ...
            for (o = 0, a = t.length; o < a; ++o) r = t[o], l = ti(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
        }
        e.capBezierPoints && function (t, e) {
            let i, s, n, o, a, r = Ce(t[0], e);
            for (i = 0, s = t.length; i < s; ++i) a = o, o = r, r = i < s - 1 && Ce(t[i + 1], e), o && (n = t[i], a && (n.cp1x = ii(n.cp1x, e.left, e.right), n.cp1y = ii(n.cp1y, e.top, e.bottom)), r && (n.cp2x = ii(n.cp2x, e.left, e.right), n.cp2y = ii(n.cp2y, e.top, e.bottom)))
        }(t, i)
    }
    const ni = t => 0 === t || 1 === t,
        oi = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * O / i),
        ai = (t, e, i) => Math.pow(2, -10 * t) * Math.sin((t - e) * O / i) + 1,
        ri = {
            linear: t => t,
            easeInQuad: t => t * t,
            easeOutQuad: t => -t * (t - 2),
            ...
            easeInOutExpo: t => ni(t) ? t : t < .5 ? .5 * Math.pow(2, 10 * (2 * t - 1)) : .5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
            easeInCirc: t => t >= 1 ? t : -(Math.sqrt(1 - t * t) - 1),
            easeOutCirc: t => Math.sqrt(1 - (t -= 1) * t),
            easeInOutCirc: t => (t /= .5) < 1 ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1),
            easeInElastic: t => ni(t) ? t : oi(t, .075, .3),
            easeOutElastic: t => ni(t) ? t : ai(t, .075, .3),
            easeInOutElastic(t) {
                const e = .1125;
                return ni(t) ? t : t < .5 ? .5 * oi(2 * t, e, .45) : .5 + .5 * ai(2 * t - 1, e, .45)
            },
            easeInBack(t) {
                const e = 1.70158;
                return t * t * ((e + 1) * t - e)
            ...
            easeInOutBounce: t => t < .5 ? .5 * ri.easeInBounce(2 * t) : .5 * ri.easeOutBounce(2 * t - 1) + .5
        };
    ...
    const di = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
        ui = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
    ...
    function _i(t, e) {
        ...
        s && !("" + s).match(ui) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
        const n = {
    ...
    function Ci(t, e, i) {
        ...
        let p, m, b, x = !1,
            _ = null;
        for (let t = c, i = c; t <= d; ++t) m = e[t % a], m.skip || (p = h(m[s]), p !== b && (x = l(p, n, o), null === _ && (x || l(n, b, p) && 0 !== r(n, b)) && (_ = 0 === r(p, n) ? t : i), null !== _ && (!x || 0 === r(o, p) || l(o, b, p)) && (g.push(Di({
            start: _,
            end: t,
            loop: u,
            count: a,
            ...
            for (const t of e) {
                ...
                for (u = d + 1; u <= t.end; u++) {
                    ...
                    e = Li(s.setContext(Mi(n, {
                        ...
                        p1DataIndex: u % l,
                        datasetIndex: a
                    }))), Ei(e, c) && f(d, u - 1, t.loop, c), o = r, c = e
                }
    ...
    var Ri = Object.freeze({
        ...
        _mergerIf: _,
        _normalizeAngle: G,
        _parseObjectDataRadialScale: Ge,
        _pointInLine: li,
        _readValueToProps: pi,
        _rlookupByKey: st,
    ...
    function Fi(t, e, i, s, n) {
        ...
        return n || t.isPointInArea(e) ? (zi(t, i, e, (function (i, a, r) {
            (n || Ce(i, t.chartArea, 0)) && i.inRange(e.x, e.y, s) && o.push({
                element: i,
                datasetIndex: a,
                index: r
            })
        ...
        modes: {
            index(t, e, i, s) {
                const n = pe(e, t),
                    ...
                    r = i.intersect ? Fi(t, n, o, s, a) : Vi(t, n, o, !1, s, a),
                    l = [];
            ...
            dataset(t, e, i, s) {
                const n = pe(e, t),
                    o = i.axis || "xy",
                    a = i.includeInvisible || !1;
                let r = i.intersect ? Fi(t, n, o, s, a) : Vi(t, n, o, !1, s, a);
                if (r.length > 0) {
            ...
            point: (t, e, i, s) => Fi(t, pe(e, t), i.axis || "xy", s, i.includeInvisible || !1),
            nearest(t, e, i, s) {
                const n = pe(e, t),
                    o = i.axis || "xy",
                    a = i.includeInvisible || !1;
                return Vi(t, n, o, i.intersect, s, a)
            },
            x: (t, e, i, s) => Bi(t, pe(e, t), "x", i.intersect, s),
            y: (t, e, i, s) => Bi(t, pe(e, t), "y", i.intersect, s)
        }
    };
    ...
    function Xi(t, e, i, s) {
        ...
        a.getPadding && Ui(r, a.getPadding());
        const l = Math.max(0, e.outerWidth - Yi(r, t, "left", "right")),
            h = Math.max(0, e.outerHeight - Yi(r, t, "top", "bottom")),
            c = l !== t.w,
            d = h !== t.h;
    ...
    function Ki(t, e, i, s) {
        ...
        for (o = 0, a = t.length, h = 0; o < a; ++o) {
            r = t[o], l = r.box, l.update(r.width || e.w, r.height || e.h, qi(r.horizontal, e));
            const {
                same: a,
                other: d
            } = Xi(e, i, r, s);
    ...
    function Zi(t, e, i, s) {
        ...
        for (const r of t) {
            ...
            if (r.horizontal) {
                const s = e.w * h,
                    o = l.size || t.height;
                k(l.start) && (a = l.start), t.fullSize ? Gi(t, n.left, a, i.outerWidth - n.right - n.left, o) : Gi(t, e.left + l.placed, a, s, o), l.start = a, l.placed += s, a = t.bottom
            } else {
                const s = e.h * h,
                    a = l.size || t.width;
                k(l.start) && (o = l.start), t.fullSize ? Gi(t, o, n.top, a, i.outerHeight - n.bottom - n.top) : Gi(t, o, e.top + l.placed, a, s), l.start = o, l.placed += s, o = t.right
            }
        }
        e.x = o, e.y = a
    }
    var Ji = {
        ...
        update(t, e, i, s) {
            ...
            const n = xi(t.options.layout.padding),
                ...
                r = function (t) {
                    const e = function (t) {
                        ...
                        i = $i(e.filter((t => t.box.fullSize)), !0),
                        s = $i(Hi(e, "left"), !0),
                        n = $i(Hi(e, "right")),
                        o = $i(Hi(e, "top"), !0),
                        a = $i(Hi(e, "bottom")),
            ...
            Ki(r.fullSize, g, d, p), Ki(l, g, d, p), Ki(h, g, d, p) && Ki(l, g, d, p),
                function (t) {
                ...
                }(g), Zi(r.leftAndTop, g, d, p), g.x += g.w, g.y += g.h, Zi(r.rightAndBottom, g, d, p), t.chartArea = {
                    left: g.left,
                    top: g.top,
                    right: g.left + g.w,
                    bottom: g.top + g.h,
    ...
    function us(t, e, i) {
        ...
        return a.observe(n),
            function (t, e) {
                hs.size || window.addEventListener("resize", ds), hs.set(t, e)
            }(t, o), a
    }

    function fs(t, e, i) {
        i && i.disconnect(), "resize" === e && function (t) {
            hs.delete(t), hs.size || window.removeEventListener("resize", ds)
        }(t)
    }
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t ? (function (t, e) {
                ...
                if (t[es] = {
                    ...
                    }, i.display = i.display || "block", i.boxSizing = i.boxSizing || "border-box", ss(n)) {
                    const e = ye(t, "width");
                    void 0 !== e && (t.width = e)
                }
                if (ss(s))
    ...
    function ms(t) {
        return !le() || "undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas ? ts : ps
    }
    ...
    class ys {
        constructor(t, e, i, s) {
            ...
            this._active = !0, this._fn = t.fn || _s[t.type || typeof o], this._easing = ri[t.easing] || ri.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = i, this._from = o, this._to = s, this._promises = void 0
        }
        active() {
            return this._active
        }
    ...
    class vs {
        ...
        _createAnimations(t, e) {
            ...
            for (r = o.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (n[l] = c = new ys(d, t, l, h), s.push(c)) : t[l] = h
            }
            return s
        }
        update(t, e) {
    ...
    function Cs(t, e) {
        ...
        for (let t = 0; t < d; ++t) {
            ...
            u = (i._stacks || (i._stacks = {}))[h] = Ps(n, c, o), u[r] = d, u._top = Ds(u, a, !0, s.type), u._bottom = Ds(u, a, !1, s.type), (u._visualValues || (u._visualValues = {}))[r] = d
        }
    }
    ...
    class Es {
        ...
        linkScales() {
            const t = this.chart,
                ...
                n = e.xAxisID = l(i.xAxisID, Os(t, "x")),
                o = e.yAxisID = l(i.yAxisID, Os(t, "y")),
                a = e.rAxisID = l(i.rAxisID, Os(t, "r")),
                r = e.indexAxis,
        ...
        _destroy() {
            const t = this._cachedMeta;
            this._data && rt(this._data, this), t._stacked && As(t)
        }
        _dataCheck() {
        ...
        buildOrUpdateElements(t) {
            ...
            this._dataCheck();
            const n = e._stacked;
            e._stacked = Ss(e.vScale, e), e.stack !== i.stack && (s = !0, As(e), e.stack = i.stack), this._resyncElements(t), (s || n !== e._stacked) && Cs(this, e._parsed)
        }
        configure() {
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a, o = ks(s, n, this._cachedMeta.index)), t.min = Math.min(t.min, o), t.max = Math.max(t.max, o)
        }
        getMinMax(t, e) {
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return f.$shared && (f.$shared = r, n[o] = Object.freeze(Ls(f, r))), f
        }
        ...
        includeOptions(t, e) {
            return !e || Ts(t) || this.chart._animationsDisabled
        }
        ...
        updateElement(t, e, i, s) {
            Ts(s) ? Object.assign(t, i) : this._resolveAnimations(e, s).update(t, i)
        }
        updateSharedOptions(t, e, i) {
            t && !Ts(e) && this._resolveAnimations(void 0, e).update(t, i)
        }
        _setStyle(t, e, i, s) {
            t.active = s;
    ...
    function Is(t, e) {
        ...
        if (r > 0) {
            ...
            for (zs(e, c, d, s(n) ? 0 : l - n, l), t = 0, i = r - 1; t < i; t++) zs(e, c, d, a[t], a[t + 1]);
            return zs(e, c, d, h, s(n) ? e.length : h + n), c
        }
        return zs(e, c, d), c
    }
    ...
    class $s extends Rs {
        ...
        update(t, e, i) {
            ...
            this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = i = Object.assign({
                ...
                top: 0,
                bottom: 0
            }, i), this.ticks = null, this._labelSizes = null, this._gridLineItems = null, this._labelItems = null, this.beforeSetDimensions(), this.setDimensions(), this.afterSetDimensions(), this._maxLength = this.isHorizontal() ? this.width + i.left + i.right : this.height + i.top + i.bottom, this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), this._range = vi(this, n, s), this._dataLimitsCached = !0), this.beforeBuildTicks(), this.ticks = this.buildTicks() || [], this.afterBuildTicks();
            const r = a < this.ticks.length;
            this._convertTicksToLabels(r ? Bs(this.ticks, a) : this.ticks), this.configure(), this.beforeCalculateLabelRotation(), this.calculateLabelRotation(), this.afterCalculateLabelRotation(), o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = Is(this, this.ticks), this._labelSizes = null, this.afterAutoSkip()), r && this._convertTicksToLabels(this.ticks), this.beforeFit(), this.fit(), this.afterFit(), this.afterUpdate()
        }
        configure() {
        ...
        calculateLabelRotation() {
            const t = this.options,
                e = t.ticks,
                i = Vs(this.ticks.length, t.ticks.maxTicksLimit),
                s = e.minRotation || 0,
                n = e.maxRotation;
            let o, a, r, l = s;
            ...
            o = t.offset ? this.maxWidth / i : u / (i - 1), c + 6 > o && (o = u / (i - (t.offset ? .5 : 1)), a = this.maxHeight - Ws(t.grid) - e.padding - Hs(t.title, this.chart.options.font), r = Math.sqrt(c * c + d * d), l = Y(Math.min(Math.asin(J((h.highest.height + 6) / o, -1, 1)), Math.asin(J(a / r, -1, 1)) - Math.asin(J(d / r, -1, 1)))), l = Math.max(s, Math.min(n, l))), this.labelRotation = l
        }
        ...
        _getLabelSizes() {
            ...
            if (!t) {
                ...
                let i = this.ticks;
                e < i.length && (i = Bs(i, e)), this._labelSizes = t = this._computeLabelSizes(i, i.length, this.options.ticks.maxTicksLimit)
            }
            return t
        }
        _computeLabelSizes(t, e, i) {
            const {
                ctx: o,
                _longestTextCache: a
            } = this, r = [], l = [], h = Math.floor(e / Vs(e, i));
            ...
            for (c = 0; c < e; c += h) {
                if (g = t[c].label, p = this._resolveTickFontOptions(c), o.font = m = p.string, b = a[m] = a[m] || {
                    ...
                    if (n(g))
                        for (d = 0, f = g.length; d < f; ++d) v = g[d], s(v) || n(v) || (_ = Me(o, b.data, b.gc, _, v), y += x)
                } else _ = Me(o, b.data, b.gc, _, g), y = x;
        ...
        getPixelForDecimal(t) {
            ...
            return Q(this._alignToPixels ? ke(this.chart, e, 0) : e)
        }
        ...
        _computeGridLineItems(t) {
            ...
            for (_ = 0; _ < d; _ += T) {
                ...
                y = Ns(this, _, h), void 0 !== y && (v = ke(i, y, o), c ? M = k = P = C = v : w = S = D = O = v, f.push({
                    tx1: M,
                    ty1: w,
                    tx2: k,
                    ty2: S,
        ...
        drawBorder() {
            ...
            const a = s.setContext(this.getContext(0)).lineWidth,
                r = this._borderValue;
            let l, h, c, d;
            this.isHorizontal() ? (l = ke(t, this.left, o) - o / 2, h = ke(t, this.right, a) + a / 2, c = d = r) : (c = ke(t, this.top, o) - o / 2, d = ke(t, this.bottom, a) + a / 2, l = h = r), e.save(), e.lineWidth = n.width, e.strokeStyle = n.color, e.beginPath(), e.moveTo(l, c), e.lineTo(h, d), e.stroke(), e.restore()
        }
        drawLabels(t) {
            ...
            for (const t of s) {
                const i = t.options,
                    s = t.font;
                Ie(e, t.label, 0, t.textOffset, s, i)
            }
            i && Ae(e)
        }
        drawTitle() {
            ...
            const {
                ...
                if (t.isHorizontal()) {
                    ...
                    } else f = "center" === i ? (c.left + c.right) / 2 - b + e : Fs(t, i, e);
        ...
        _resolveTickFontOptions(t) {
            return _i(this.options.ticks.setContext(this.getContext(t)).font)
        }
        _maxDigits() {
    ...
    class Ys {
        ...
        register(t) {
            ...
            return n in s || (s[n] = t, function (t, e, i) {
                const s = b(Object.create(null), [i ? re.get(i) : {}, re.get(e), t.defaults]);
                ...
                }(e, t.defaultRoutes), t.descriptors && re.describe(e, t.descriptors)
    ...
    var Us = new class {
        constructor() {
            this.controllers = new Ys(Es, "datasets", !0), this.elements = new Ys(Rs, "elements"), this.plugins = new Ys(Object, "plugins"), this.scales = new Ys($s, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
        }
        add(...t) {
    ...
    function Js(t, ...e) {
        if (Zs(t)) return t;
        for (const s of e) {
            const e = s.axis || ("top" === (i = s.position) || "bottom" === i ? "x" : "left" === i || "right" === i ? "y" : void 0) || t.length > 1 && Zs(t[0].toLowerCase());
            if (e) return e
        }
        var i;
    ...
    function tn(t) {
        ...
        e.plugins = l(e.plugins, {}), e.scales = function (t, e) {
            ...
            return Object.keys(s).forEach((e => {
                ...
                const l = Js(e, r, function (t, e) {
                        if (e.data && e.data.datasets) {
                            const i = e.data.datasets.filter((e => e.xAxisID === t || e.yAxisID === t));
                            if (i.length) return Qs(t, "x", i[0]) || Qs(t, "y", i[0])
                        }
                        return {}
    ...
    class rn {
        ...
        getOptionScopes(t, e, i) {
            ...
            const r = new Set;
            e.forEach((e => {
                t && (r.add(t), e.forEach((e => an(r, t, e)))), e.forEach((t => an(r, s, t))), e.forEach((t => an(r, se[n] || {}, t))), e.forEach((t => an(r, re, t))), e.forEach((t => an(r, ne, t)))
            }));
            const l = Array.from(r);
            return 0 === l.length && l.push(Object.create(null)), nn.has(e) && o.set(e, l), l
        }
        chartOptionScopes() {
            const {
                options: t,
            ...
            (function (t, e) {
                ...
                for (const o of e) {
                    const e = i(o),
                        a = s(o),
                        r = (a || e) && t[o];
                    if (e && (S(r) || hn(r)) || a && n(r)) return !0
                }
                return !1
            })(a, e) && (o.$shared = !1, l = Ve(a, i = S(i) ? i() : i, this.createResolver(t, i, r)));
        ...
        createResolver(t, e, i = [""], s) {
            const {
                resolver: n
            } = ln(this._resolverCache, t, i);
            return o(e) ? Ve(n, e, void 0, s) : n
        }
    }
    ...
    const hn = t => o(t) && Object.getOwnPropertyNames(t).reduce(((e, i) => e || S(t[i])), !1),
    ...
    class _n {
        ...
        _resize(t, e) {
            ...
            this.width = o.width, this.height = o.height, this._aspectRatio = this.aspectRatio, xe(this, a, !0) && (this.notifyPlugins("resize", {
                size: o
        ...
        buildOrUpdateScales() {
            ...
            e && (n = n.concat(Object.keys(e).map((t => {
                ...
                let h = null;
                o in i && i[o].type === r ? h = i[o] : (h = new(Us.getScale(r))({
                    id: o,
                    type: r,
                    ctx: this.ctx,
                    chart: this
        ...
        _updateHiddenIndices() {
            ...
            for (const {
                    ...
                    start: s,
                    count: n
                } of e) xn(t, s, "_removeElements" === i ? -n : n)
        }
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (bt.has(this) ? this.attached && !bt.running(this) && bt.start(this) : (this.draw(), fn({
                chart: this
            })))
        }
        draw() {
        ...
        _drawDataset(t) {
            ...
            !1 !== this.notifyPlugins("beforeDatasetDraw", o) && (s && Oe(e, {
                left: !1 === i.left ? 0 : n.left - i.left,
                right: !1 === i.right ? this.width : n.right + i.right,
                top: !1 === i.top ? 0 : n.top - i.top,
                bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom
            }), t.controller.draw(), s && Ae(e), o.cancelable = !1, this.notifyPlugins("afterDatasetDraw", o))
        }
        isPointInArea(t) {
        ...
        destroy() {
            ...
            this._stop(), this.config.clearCache(), t && (this.unbindEvents(), Se(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete mn[this.id], this.notifyPlugins("afterDestroy")
        }
        toBase64Image(...t) {
    ...
    function yn() {
        return u(_n.instances, (t => t._plugins.invalidate()))
    }
    ...
    function Pn(t, e, i, s) {
        const n = t.iScale,
            ...
            l = [];
        let h, c, d, u;
        for (h = i, c = i + s; h < c; ++h) u = e[h], d = {}, d[n.axis] = r || n.parse(a[h], h), l.push(Sn(u, d, o, h));
        return l
    }
    ...
    function On(t, e, i, s) {
        var n, o, a;
        return s ? (a = i, t = An(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = An(t, e, i), t
    }
    ...
    var Rn = Object.freeze({
        __proto__: null,
        BarController: class extends Es {
            static id = "bar";
            static defaults = {
                datasetElementType: !1,
                dataElementType: "bar",
            ...
            parseObjectData(t, e, i, s) {
                ...
                let d, u, f, g;
                for (d = i, u = i + s; d < u; ++d) g = e[d], f = {}, f[n.axis] = n.parse(M(g, l), d), c.push(Sn(M(g, h), f, o, d));
                return c
            }
            updateRangeFromParsed(t, e, i, s) {
            ...
            getLabelAndValue(t) {
                const e = this._cachedMeta,
                    ...
                    n = this.getParsed(t),
                    o = n._custom,
                    a = Dn(o) ? "[" + o.start + ", " + o.end + "]" : "" + s.getLabelForValue(n[s.axis]);
                return {
                ...
                for (let f = e; f < e + i; f++) {
                    const e = this.getParsed(f),
                        ...
                        m = {
                            horizontal: h,
                            base: i.base,
                            enableBorderRadius: !p || Dn(e._custom) || a === p._top || a === p._bottom,
                            x: h ? i.head : g.center,
                            y: h ? g.center : i.head,
                    ...
                    Cn(m, b, p, a), Tn(m, b, c.ratio), this.updateElement(t[f], f, m, n)
                }
            }
            _getStacks(t, e) {
                const {
            ...
            _calculateBarValuePixels(t) {
                ...
                } = this, r = o || 0, l = this.getParsed(t), h = l._custom, c = Dn(h);
                let d, u, f = l[e.axis],
                    g = 0,
        ...
        BubbleController: class extends Es {
            static id = "bubble";
            static defaults = {
                datasetElementType: !1,
        ...
        DoughnutController: Ln,
        LineController: class extends Es {
            static id = "line";
            static defaults = {
        ...
        PieController: class extends Ln {
            static id = "pie";
            static defaults = {
                cutout: 0,
                rotation: 0,
        ...
        RadarController: class extends Es {
            static id = "radar";
            static defaults = {
                datasetElementType: "line",
                dataElementType: "point",
        ...
        ScatterController: class extends Es {
            static id = "scatter";
            static defaults = {
                datasetElementType: !1,
                dataElementType: "point",
    ...
    function zn(t, e, i, s, n, o) {
        ...
        const p = (g - Math.max(.001, g * d - i / C) / d) / 2,
            ...
            b = n - p - f,
            {
                ...
                const n = pi(t.options.borderRadius, ["outerStart", "outerEnd", "innerStart", "innerEnd"]),
                    o = (i - e) / 2,
                    a = Math.min(o, s * e / 2),
                    r = t => {
    ...
    function Nn(t, e, i, s) {
        const {
            ...
            return t.stepped ? Te : t.tension || "monotone" === t.cubicInterpolationMode ? Le : Vn
        }(o);
        let d, u, f, {
            move: g = !0,
            reverse: p
    ...
    function Hn(t) {
        ...
        return t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i ? Nn : Wn
    }
    ...
    class $n extends Rs {
        ...
        interpolate(t, e) {
            ...
            const a = [],
                r = function (t) {
                    return t.stepped ? hi : t.tension || "monotone" === t.cubicInterpolationMode ? ci : li
                }(i);
            let l, h;
        ...
        draw(t, e, i, s) {
            ...
            (this.points || []).length && n.borderWidth && (t.save(), function (t, e, i, s) {
                jn && !e.options.segment ? function (t, e, i, s) {
                    let n = e._path;
                    n || (n = e._path = new Path2D, e.path(n, i, s) && n.closePath()), Fn(t, e.options), t.stroke(n)
                }(t, e, i, s) : function (t, e, i, s) {
                    const {
                        segments: n,
                        options: o
                    } = e, a = Hn(e);
                    for (const r of n) Fn(t, o, r.style), t.beginPath(), a(t, e, r, {
                        start: i,
                        end: i + s - 1
    ...
    function qn(t) {
        const e = Un(t),
            ...
            a = function (t, e, i) {
                ...
                } = t.getProps(["enableBorderRadius"]), n = t.options.borderRadius, a = bi(n), r = Math.min(e, i), l = t.borderSkipped, h = s || o(n);
                return {
                    topLeft: Xn(!h || l.top || l.left, a.topLeft, 0, r),
                    topRight: Xn(!h || l.top || l.right, a.topRight, 0, r),
                    bottomLeft: Xn(!h || l.bottom || l.left, a.bottomLeft, 0, r),
                    bottomRight: Xn(!h || l.bottom || l.right, a.bottomRight, 0, r)
                }
            }(t, i / 2, s / 2);
        return {
            outer: {
    ...
    var Jn = Object.freeze({
            ...
            draw(t) {
                ...
                t.fillStyle = e.backgroundColor, t.strokeStyle = e.borderColor,
                    ...
                    function (t, e, i, s, n) {
                        ...
                        }(t, e, g), o || (zn(t, e, i, s, g, n), t.stroke())
                    }(t, this, r, n, o), t.restore()
            }
        },
        BarElement: class extends Rs {
            static id = "bar";
            static defaults = {
                borderSkipped: "start",
                borderWidth: 0,
            ...
            draw(t) {
                const {
                    ...
                    inner: n,
                    outer: o
                } = qn(this), a = (r = o.radius).topLeft || r.topRight || r.bottomLeft || r.bottomRight ? ze : Gn;
                var r;
        ...
        PointElement: class extends Rs {
            ...
            draw(t, e) {
                const i = this.options;
                this.skip || i.radius < .1 || !Ce(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor, t.lineWidth = i.borderWidth, t.fillStyle = i.backgroundColor, Pe(t, i, this.x, this.y))
            }
            getRange() {
                const t = this.options || {};
    ...
    class eo extends $s {
        ...
        buildTicks() {
            ...
            const n = function (t, e) {
                ...
                for (b && (u && M !== a ? (i.push({
                        value: a
                    }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, to(a, y, t)) && D++) : M < a && D++); D < k; ++D) {
                ...
                return x && u && w !== r ? i.length && V(i[i.length - 1].value, r, to(r, y, t)) ? i[i.length - 1].value = r : i.push({
                    value: r
                }) : x && w !== r || i.push({
                    value: w
                }), i
    ...
    const so = t => Math.floor(z(t)),
        no = (t, e) => Math.pow(10, so(t) + e);

    function oo(t) {
        return 1 == t / Math.pow(10, so(t))
    }
    ...
    class ro extends $s {
        ...
        determineDataLimits() {
            ...
            this.min = a(t) ? Math.max(0, t) : null, this.max = a(e) ? Math.max(0, e) : null, this.options.beginAtZero && (this._zero = !0), this._zero && this.min !== this._suggestedMin && !a(this._userMin) && (this.min = t === no(this.min, 0) ? no(this.min, -1) : no(this.min, 0)), this.handleTickRangeOptions()
        }
        handleTickRangeOptions() {
            const {
                minDefined: t,
            ...
            const n = e => i = t ? i : e,
                o = t => s = e ? s : t;
            i === s && (i <= 0 ? (n(1), o(10)) : (n(no(i, -1)), o(no(s, 1)))), i <= 0 && n(no(s, -1)), s <= 0 && o(no(i, 1)), this.min = i, this.max = s
        }
        buildTicks() {
            const t = this.options,
                e = function (t, {
    ...
    function lo(t) {
        ...
        if (e.display && t.display) {
            ...
            return l(e.font && e.font.size, re.font.size) + t.height
        }
        return 0
    }
    ...
    function go(t, e, i) {
        ...
        if (!s(l)) {
            const i = bi(e.borderRadius),
                s = xi(e.backdropPadding);
            t.fillStyle = l;
            const h = n - s.left,
                c = o - s.top,
                d = a - n + s.width,
                u = r - o + s.height;
            Object.values(i).some((t => 0 !== t)) ? (t.beginPath(), ze(t, {
                x: h,
                y: c,
                w: d,
                h: u,
    ...
    class mo extends eo {
        ...
        setDimensions() {
            const t = this._padding = xi(lo(this.options) / 2),
            ...
            t.display && t.pointLabels.display ? function (t) {
                ...
                for (let u = 0; u < a; u++) {
                    ...
                    const m = G(t.getIndexAngle(u) + l),
                        b = Math.round(Y(m));
                    co(i, e, m, ho(b, f.x, p.w, 0, 180), ho(b, f.y, p.h, 90, 270))
                }
                var h, c, d;
                t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b), t._pointLabelItems = function (t, e, i) {
                    ...
                    for (let o = 0; o < n; o++) {
                        ...
                        const n = uo(t, o, l);
                        s.push(n), "auto" === r && (n.visible = fo(n, h), n.visible && (h = n))
                    }
                    return s
                }(t, s, o)
        ...
        drawBackground() {
            ...
            if (t) {
                const i = this.ctx;
                i.save(), i.beginPath(), po(this, this.getDistanceFromCenterForValue(this._endValue), e, this._pointLabels.length), i.closePath(), i.fillStyle = t, i.fill(), i.restore()
            }
        }
        drawGrid() {
            const t = this.ctx,
            ...
            if (e.pointLabels.display && function (t, e) {
                    ...
                    for (let n = e - 1; n >= 0; n--) {
                        ...
                        Ie(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, {
                            color: o.color,
                            textAlign: h,
                            textBaseline: "middle"
                        })
                    ...
                    if (0 !== e) {
                        ...
                        ! function (t, e, i, s, n) {
                            ...
                            !a && !s || !r || !l || i < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash), o.lineDashOffset = n.dashOffset, o.beginPath(), po(t, i, a, s), o.closePath(), o.stroke(), o.restore())
                        }(this, a, r, o, l)
                    }
                })), i.display) {
    ...
    function vo(t, e, i, s) {
        const n = xo.length;
        for (let o = xo.indexOf(t); o < n - 1; ++o) {
            const t = bo[xo[o]],
                n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
            if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return xo[o]
        }
        return xo[n - 1]
    }
    ...
    class ko extends $s {
        ...
        parse(t, e) {
            return void 0 === t ? null : yo(this, t)
        }
        beforeLayout() {
        ...
        buildTicks() {
            ...
            return this._unit = e.unit || (i.autoSkip ? vo(e.minUnit, this.min, this.max, this._getLabelCapacity(n)) : function (t, e, i, s, n) {
                for (let o = xo.length - 1; o >= xo.indexOf(i); o--) {
                    const i = xo[o];
                    if (bo[i].common && t._adapter.diff(n, s, i) >= e - 1) return i
                }
                return xo[i ? xo.indexOf(i) : 0]
            }(this, o.length, e.minUnit, this.min, this.max)), this._majorUnit = i.major.enabled && "year" !== this._unit ? function (t) {
                for (let e = xo.indexOf(t) + 1, i = xo.length; e < i; ++e)
                    if (bo[xo[e]].common) return xo[e]
        ...
        _generate() {
            ...
            for (d = f, u = 0; d < i; d = +t.add(d, a, o), u++) Mo(c, d, g);
            return d !== i && "ticks" !== s.bounds && 1 !== u || Mo(c, d, g), Object.keys(c).sort(((t, e) => t - e)).map((t => +t))
        }
        getLabelForValue(t) {
    ...
    var Po = Object.freeze({
        ...
        CategoryScale: class extends $s {
            ...
            parse(t, e) {
                ...
                return ((t, e) => null === t ? null : J(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : function (t, e, i, s) {
                    const n = t.indexOf(e);
        ...
        TimeSeriesScale: class extends ko {
            ...
            getValueForPixel(t) {
                const e = this._offsets,
                    i = this.getDecimalForPixel(t) / e.factor - e.end;
                return So(this._table, i * this._tableRange + this._minPos, !0)
            }
        }
    });
    const Do = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
        Co = Do.map((t => t.replace("rgb(", "rgba(").replace(")", ", 0.5)")));
    ...
    var Lo = {
        ...
        beforeLayout(t, e, i) {
            ...
            if (!i.forceOverride && (To(s) || (a = n) && (a.borderColor || a.backgroundColor) || o && To(o))) return;
            var a;
            const r = function (t) {
                let e = 0;
                return (i, s) => {
                    const n = t.getDatasetMeta(s).controller;
                    n instanceof Ln ? e = function (t, e) {
                        return t.backgroundColor = t.data.map((() => Oo(e++))), e
                    }(i, e) : n instanceof En ? e = function (t, e) {
                        return t.backgroundColor = t.data.map((() => Ao(e++))), e
                    }(i, e) : n && (e = function (t, e) {
                        return t.borderColor = Oo(e), t.backgroundColor = Ao(e), ++e
                    }(i, e))
                }
            }(t);
            s.forEach(r)
    ...
    function Uo(t) {
        ...
        return n instanceof Yo ? n : Bo(n, s)
    }
    ...
    function Xo(t, e, i) {
        ...
        s && n.points.length && (Oe(t, i), function (t, e) {
            const {
                line: i,
                target: s,
                above: n,
            ...
            t.save(), "x" === l && o !== n && (qo(t, s, a.top), Ko(t, {
                line: i,
                target: s,
                color: n,
                scale: r,
                property: l
            }), t.restore(), t.save(), qo(t, s, a.bottom)), Ko(t, {
                line: i,
                target: s,
                color: o,
                scale: r,
    ...
    function Ko(t, e) {
            ...
            for (const t of s) {
                ...
                for (const e of h) {
                    ...
                    for (const t of r) a.push({
                        ...
                        target: e,
                        start: {
                            [i]: Vo(l, s, "start", Math.max)
                        },
                        end: {
                            [i]: Vo(l, s, "end", Math.min)
                        }
                    })
                }
            }
        ...
        for (const {
            ...
            t.save(), t.fillStyle = r, Go(t, a, d && zo(n, h, c)), t.beginPath();
            const u = !!i.pathSegment(t, e);
            let f;
            if (d) {
                u ? t.closePath() : Zo(t, s, c, n);
    ...
    var Jo = {
        ...
        afterDatasetsUpdate(t, e, i) {
            const s = (t.data.datasets || []).length,
                n = [];
            let o, a, r, l;
            for (a = 0; a < s; ++a) o = t.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof $n && (l = {
            ...
            for (a = 0; a < s; ++a) l = n[a], l && !1 !== l.fill && (l.fill = Wo(n, a, i.propagate))
        },
        beforeDraw(t, e, i) {
        ...
        beforeDatasetsDraw(t, e, i) {
            ...
            for (let e = s.length - 1; e >= 0; --e) {
                const i = s[e].$filler;
                No(i) && Xo(t.ctx, i, t.chartArea)
            }
        },
        beforeDatasetDraw(t, e, i) {
            const s = e.meta.$filler;
            No(s) && "beforeDatasetDraw" === i.drawTime && Xo(t.ctx, s, t.chartArea)
        },
        defaults: {
            propagate: !0,
    ...
    class ta extends Rs {
            ...
            return this.legendItems.forEach(((t, o) => {
                const {
                    ...
                    const o = function (t, e, i, s) {
                        ...
                        a = function (t, e, i) {
                            let s = t;
                            return "string" != typeof e.text && (s = ea(e, i)), s
                        }(n, s, e.lineHeight);
                    return {
                        itemWidth: o,
                        itemHeight: a
        ...
        _draw() {
            const {
                ...
                align: n,
                labels: o
            } = t, a = re.color, r = wi(t.rtl, this.left, this.width), h = _i(o.font), {
                padding: c
            } = o, d = h.size, u = d / 2;
            let f;
            ...
            const {
                ...
                boxHeight: p,
                itemHeight: m
            } = Qo(o, d), b = this.isHorizontal(), x = this._computeTitleHeight();
            f = b ? {
            ...
            this.legendItems.forEach(((y, v) => {
                ...
                let S = f.x,
                    P = f.y;
                if (r.setWidth(this.width), b ? v > 0 && S + k + c > this.right && (P = f.y += _, f.line++, S = f.x = ft(n, this.left + c, this.right - i[f.line])) : v > 0 && P + _ > this.bottom && (S = f.x = S + e[f.line].width + c, f.line++, P = f.y = ft(n, this.top + x + c, this.bottom - e[f.line].height)), function (t, e, i) {
                        ...
                        if (s.fillStyle = l(i.fillStyle, a), s.lineCap = l(i.lineCap, "butt"), s.lineDashOffset = l(i.lineDashOffset, 0), s.lineJoin = l(i.lineJoin, "miter"), s.lineWidth = n, s.strokeStyle = l(i.strokeStyle, a), s.setLineDash(l(i.lineDash, [])), o.usePointStyle) {
                            const a = {
                                ...
                                l = r.xPlus(t, g / 2);
                            De(s, a, l, e + u, o.pointStyleWidth && g)
                        } else {
                            const o = e + Math.max((d - p) / 2, 0),
                                a = r.leftForLtr(t, g),
                                l = bi(i.borderRadius);
                            s.beginPath(), Object.values(l).some((t => 0 !== t)) ? ze(s, {
                                x: a,
                                y: o,
                                w: g,
                                h: p,
        ...
        drawTitle() {
            ...
            const u = ft(a, c, c + d);
            o.textAlign = n.textAlign(ut(a)), o.textBaseline = "middle", o.strokeStyle = e.color, o.fillStyle = e.color, o.font = i.string, Ie(o, e.text, u, h, i)
        }
        _computeTitleHeight() {
    ...
    class sa extends Rs {
        ...
        update(t, e) {
            ...
            const o = s * _i(i.font).lineHeight + this._padding.height;
    ...
    var aa = {
        ...
        start(t, e, i) {
            ...
            Ji.configure(t, s, i), Ji.addBox(t, s), oa.set(t, s)
        },
        stop(t) {
            Ji.removeBox(t, oa.get(t)), oa.delete(t)
        },
        beforeUpdate(t, e, i) {
            const s = oa.get(t);
            Ji.configure(t, s, i), s.options = i
    ...
    function fa(t, e, i) {
        ...
        return {
            xAlign: i.xAlign || e.xAlign || ua(t, e, i, s),
            yAlign: s
        }
    }
    ...
    function _a(t, e, i, s) {
        ...
        return void 0 === n ? xa[e].call(i, s) : n
    }
    class ya extends Rs {
        ...
        getTitle(t, e) {
            const {
                callbacks: i
            } = e, s = _a(i, "beforeTitle", this, t), n = _a(i, "title", this, t), o = _a(i, "afterTitle", this, t);
            let a = [];
            return a = la(a, ha(s)), a = la(a, ha(n)), a = la(a, ha(o)), a
        }
        getBeforeBody(t, e) {
            return ma(_a(e.callbacks, "beforeBody", this, t))
        }
        getBody(t, e) {
            const {
                callbacks: i
            ...
            return u(t, (t => {
                const e = {
                    ...
                    n = ba(i, t);
                la(e.before, ha(_a(n, "beforeLabel", this, t))), la(e.lines, _a(n, "label", this, t)), la(e.after, ha(_a(n, "afterLabel", this, t))), s.push(e)
            })), s
        }
        getAfterBody(t, e) {
            return ma(_a(e.callbacks, "afterBody", this, t))
        }
        getFooter(t, e) {
            const {
                callbacks: i
            } = e, s = _a(i, "beforeFooter", this, t), n = _a(i, "footer", this, t), o = _a(i, "afterFooter", this, t);
            let a = [];
            return a = la(a, ha(s)), a = la(a, ha(n)), a = la(a, ha(o)), a
        }
        _createItems(t) {
            ...
            return t.filter && (l = l.filter(((e, s, n) => t.filter(e, s, n, i)))), t.itemSort && (l = l.sort(((e, s) => t.itemSort(e, s, i)))), u(l, (e => {
                const i = ba(t.callbacks, e);
                s.push(_a(i, "labelColor", this, e)), n.push(_a(i, "labelPointStyle", this, e)), o.push(_a(i, "labelTextColor", this, e))
        ...
        update(t, e) {
            ...
            let n, o = [];
            if (s.length) {
                const t = ra[i.position].call(this, s, this._eventPosition);
                o = this._createItems(i), this.title = this.getTitle(o, i), this.beforeBody = this.getBeforeBody(o, i), this.body = this.getBody(o, i), this.afterBody = this.getAfterBody(o, i), this.footer = this.getFooter(o, i);
                const e = this._size = da(this, i),
                    a = Object.assign({}, t, e),
                    r = fa(this.chart, i, a),
                    l = ga(i, a, r, this.chart);
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = pa(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = _i(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r) e.fillText(s[r], l.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + a, r + 1 === n && (t.y += i.titleMarginBottom - a)
            }
        }
        _drawColorBox(t, e, i, s, n) {
            ...
            if (n.usePointStyle) {
                const e = {
                    ...
                    o = g + l / 2;
                t.strokeStyle = n.multiKeyBackground, t.fillStyle = n.multiKeyBackground, Pe(t, e, i, o), t.strokeStyle = a.borderColor, t.fillStyle = a.backgroundColor, Pe(t, e, i, o)
            } else {
                ...
                const e = s.leftForLtr(u, h),
                    ...
                    r = bi(a.borderRadius);
                Object.values(r).some((t => 0 !== t)) ? (t.beginPath(), t.fillStyle = n.multiKeyBackground, ze(t, {
                    x: e,
                    y: g,
                    w: h,
                    h: l,
                    radius: r
                }), t.fill(), t.stroke(), t.fillStyle = a.backgroundColor, t.beginPath(), ze(t, {
                    x: i,
                    y: g + 1,
                    w: h - 2,
                    h: l - 2,
        ...
        drawBody(t, e, i) {
            ...
            let d = c.lineHeight,
                f = 0;
            const g = wi(i.rtl, this.x, this.width),
                p = function (i) {
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = pa(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = _i(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a) e.fillText(s[a], r.x(t.x), t.y + o.lineHeight / 2), t.y += o.lineHeight + i.footerSpacing
            }
        }
        ...
        draw(t) {
            ...
            e.enabled && a && (t.save(), t.globalAlpha = i, this.drawBackground(n, t, s, e), ki(t, e.textDirection), n.y += o.top, this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), Si(t, e.textDirection), t.restore())
        }
        getActiveElements() {
            return this._active || []
        }
        ...
        _positionChanged(t, e) {
            const {
                ...
                caretY: s,
                options: n
            } = this, o = ra[n.position].call(this, t, e);
